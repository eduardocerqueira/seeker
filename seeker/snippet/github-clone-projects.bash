...
github-clone-projects() {
    ...
    readonly sGithubDomain="${aParameters[0]?Three parameters required: "**********"
    readonly sId="${aParameters[1]?Three parameters required: "**********"
    readonly sGithubToken="${aParameters[2]?Three parameters required: "**********"
