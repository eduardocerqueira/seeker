#date: 2024-10-04T16:45:42Z
#url: https://api.github.com/gists/44535f6f28d1b023a34d47e97f275817
#owner: https://api.github.com/users/kodek
...
class Pipeline:
    ...
    async def inlet(self, body: dict, user: Optional[dict] = None) -> dict:
        ...
        self.chat_trace[body["chat_id"]] = trace
    ...
    async def outlet(self, body: dict, user: Optional[dict] = None) -> dict:
        ...
        trace = self.chat_trace[body["chat_id"]]
        ...
        if assistant_message_obj:
            ...
            if isinstance(info, dict):
                input_tokens = "**********"
                output_tokens = "**********"
 "**********"  "**********"  "**********"  "**********"  "**********"  "**********"  "**********"  "**********"  "**********"  "**********"  "**********"  "**********"  "**********"  "**********"  "**********"  "**********"  "**********"i "**********"f "**********"  "**********"i "**********"n "**********"p "**********"u "**********"t "**********"_ "**********"t "**********"o "**********"k "**********"e "**********"n "**********"s "**********"  "**********"i "**********"s "**********"  "**********"n "**********"o "**********"t "**********"  "**********"N "**********"o "**********"n "**********"e "**********"  "**********"a "**********"n "**********"d "**********"  "**********"o "**********"u "**********"t "**********"p "**********"u "**********"t "**********"_ "**********"t "**********"o "**********"k "**********"e "**********"n "**********"s "**********"  "**********"i "**********"s "**********"  "**********"n "**********"o "**********"t "**********"  "**********"N "**********"o "**********"n "**********"e "**********": "**********"
                    usage = {
                        "input": "**********"
                        "output": "**********"
                        "unit": "**********"
        ...
        generation.end(
            ...
            metadata={"interface": "open-webui", "full_body":json.dumps(body)},
            usage=usage,
        )
        ...
        del self.chat_trace[body["chat_id"]]
