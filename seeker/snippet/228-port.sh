#date: 2026-02-27T17:09:29Z
#url: https://api.github.com/gists/5fbb092f10fdc2dce562fe5d0e05f8f3
#owner: https://api.github.com/users/vomaestroj
...
helm upgrade --install \
    ...
    --set secret.secrets.portClientId= "**********"
    --set secret.secrets.portClientSecret= "**********"
