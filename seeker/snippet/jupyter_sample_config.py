#date: 2023-01-23T16:55:08Z
#url: https://api.github.com/gists/409b02c5501834e156e2024d71e784ec
#owner: https://api.github.com/users/GotamDahiya
...
# get_config is again called to differentiate between the default call and user-defined call. The default call can also be used as defined on line 3. Remove line 89 and replace remaining 'conf' with 'c'.
...
#  Choices: any of ['sha3_384', 'sha256', 'md5', 'blake2b', 'sha224', 'sha3_224', 'sha512', 'blake2s', 'sha3_512', 'sha1', 'sha3_256', 'sha384']
#  Default: 'sha256'
