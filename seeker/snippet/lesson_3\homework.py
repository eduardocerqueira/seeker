#date: 2024-05-20T16:57:43Z
#url: https://api.github.com/gists/9ad968fcfb5d48e0fcb72ee52b0c8ce8
#owner: https://api.github.com/users/shrutipreman
...
cardio= int(input("Enter the total minutes spent on cardio:"))
strength_training = int(input("Enter the total minutes spent in strength training:"))
yoga = int(input("Enter the total minutes spend on yoga:"))
total_time = cardio + strength_training + yoga
if (total_time < 30):
    print(f"{total_time} is the total exercise time this week .You can do better!")
else:
    print(f"{total_time} minutes, Great job!")
...
input_number = -324
num_str = str(input_number)
reversed_str = num_str[-1:-4:-1]
reversed_number = int(num_str[0] + reversed_str)
