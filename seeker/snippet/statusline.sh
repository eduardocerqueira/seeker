#date: 2026-02-13T17:35:50Z
#url: https://api.github.com/gists/ce2f8c2546155f5218c542f5763d8c01
...
' 2>/dev/null)" || {
  ...
  input_tokens= "**********"=0; cache_write=0; cache_read=0
...
format_tokens() {
    ...
    if [ "$tokens" -ge 1000000 ]; then
        printf "%.1fM" "$(echo "scale= "**********"
    elif [ "$tokens" -ge 1000 ]; then
        printf "%.1fK" "$(echo "scale= "**********"
    else
        echo "$tokens"
    fi
}
