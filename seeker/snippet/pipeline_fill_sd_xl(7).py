#date: 2025-04-18T16:46:47Z
#url: https://api.github.com/gists/53ca00c003d44b7bb9b83fcaf2bf6c70
#owner: https://api.github.com/users/remphan1618
...
class StableDiffusionXLFillPipeline(DiffusionPipeline, StableDiffusionMixin):
 ...
 "**********"  "**********"  "**********"  "**********"  "**********"  "**********"  "**********"  "**********"  "**********"f "**********"o "**********"r "**********"  "**********"p "**********"r "**********"o "**********"m "**********"p "**********"t "**********", "**********"  "**********"t "**********"o "**********"k "**********"e "**********"n "**********"i "**********"z "**********"e "**********"r "**********", "**********"  "**********"t "**********"e "**********"x "**********"t "**********"_ "**********"e "**********"n "**********"c "**********"o "**********"d "**********"e "**********"r "**********"  "**********"i "**********"n "**********"  "**********"z "**********"i "**********"p "**********"( "**********"p "**********"r "**********"o "**********"m "**********"p "**********"t "**********"s "**********", "**********"  "**********"t "**********"o "**********"k "**********"e "**********"n "**********"i "**********"z "**********"e "**********"r "**********"s "**********", "**********"  "**********"t "**********"e "**********"x "**********"t "**********"_ "**********"e "**********"n "**********"c "**********"o "**********"d "**********"e "**********"r "**********"s "**********") "**********": "**********"
            text_inputs = "**********"
                prompt,
                padding="max_length",
                max_length= "**********"
