#date: 2025-05-07T17:10:52Z
#url: https://api.github.com/gists/51e52f90b305f4f50eef5ad166eff569
#owner: https://api.github.com/users/lorenzo
...
class mysql_source(object):
 ...
 "**********"  "**********"  "**********"  "**********"  "**********"  "**********"  "**********"  "**********"  "**********"  "**********"  "**********"  "**********"  "**********"  "**********"  "**********"  "**********"  "**********"  "**********"  "**********"  "**********"  "**********"f "**********"o "**********"r "**********"  "**********"t "**********"o "**********"k "**********"e "**********"n "**********"  "**********"i "**********"n "**********"  "**********"s "**********"q "**********"l "**********"_ "**********"t "**********"o "**********"k "**********"e "**********"n "**********"i "**********"s "**********"e "**********"r "**********". "**********"t "**********"o "**********"k "**********"e "**********"n "**********"i "**********"s "**********"e "**********"d "**********": "**********"
                        write_ddl = True
                        table_name = "**********"
