#date: 2024-01-18T17:03:29Z
#url: https://api.github.com/gists/5606a7f562f828b96b6916073c0230de
#owner: https://api.github.com/users/librash
...
sudo sed -i -e 's/#sonar.jdbc.password= "**********"=huawei123/g' /opt/sonarqube/conf/sonar.properties
