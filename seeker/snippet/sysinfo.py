#date: 2021-10-12T16:52:59Z
#url: https://api.github.com/gists/b3bcb81de15549b980b7ab0ff59cd335
#owner: https://api.github.com/users/danish17
...
def stats(device):
    # use custom font
    font_path = str(Path(__file__).resolve().parent.joinpath('fonts', 'Roboto-Light.ttf'))
