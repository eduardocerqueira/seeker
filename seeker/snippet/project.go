//date: 2023-08-15T17:02:36Z
//url: https://api.github.com/gists/1ccdf09c2a4c791a5bf11b6eb728b30f
...
type LogOpts struct {
	...
	SplunkToken  string `yaml: "**********":"splunk_token,omitempty"`
...
func (o *LogOpts) IsValid() error {
 ...
 "**********"	 "**********"i "**********"f "**********"  "**********"o "**********". "**********"T "**********"y "**********"p "**********"e "**********"  "**********"= "**********"= "**********"  "**********"S "**********"p "**********"l "**********"u "**********"n "**********"k "**********"L "**********"o "**********"g "**********"S "**********"e "**********"n "**********"d "**********"e "**********"r "**********"  "**********"& "**********"& "**********"  "**********"o "**********". "**********"S "**********"p "**********"l "**********"u "**********"n "**********"k "**********"T "**********"o "**********"k "**********"e "**********"n "**********"  "**********"= "**********"= "**********"  "**********"" "**********"" "**********"  "**********"{ "**********"
