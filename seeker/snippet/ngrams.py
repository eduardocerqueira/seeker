#date: 2025-02-17T16:52:35Z
#url: https://api.github.com/gists/345b7e52798557e3ed7ff696ba5a4902
#owner: https://api.github.com/users/0xack13
...
def count_ngrams(lines, min_length=2, max_length=4):
    ...
    for line in lines:
 "**********"  "**********"  "**********"  "**********"  "**********"  "**********"  "**********"  "**********"  "**********"f "**********"o "**********"r "**********"  "**********"w "**********"o "**********"r "**********"d "**********"  "**********"i "**********"n "**********"  "**********"t "**********"o "**********"k "**********"e "**********"n "**********"i "**********"z "**********"e "**********"( "**********"l "**********"i "**********"n "**********"e "**********") "**********": "**********"
            queue.append(word)
