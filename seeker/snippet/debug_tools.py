#date: 2025-12-24T17:13:18Z
#url: https://api.github.com/gists/c16782d594e844209c92ea8f3f4f8bca
...
def find_traceback_in_files(file_paths, cpus=multiprocessing.cpu_count()):
    '''Find tracebacks in files using multiprocessing for fast results.
