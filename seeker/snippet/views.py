#date: 2022-07-22T16:59:09Z
#url: https://api.github.com/gists/5f18dc006a811e6fcd342323d6a7da68
#owner: https://api.github.com/users/koszti
...
class AuthOAuthView(AuthView):
    ...
    def oauth_authorized(self, provider: str) -> WerkzeugResponse:
        ...
        try:
            ...
            print(self.appbuilder.sm.oauth_whitelists)
            ...
            if provider in self.appbuilder.sm.oauth_whitelists:
                ...
                for email in whitelist:
                    if "email" in userinfo and re.search(email, userinfo["email"]):
                        ...
                        break
                if not allow:
                    print("not allowed whitelist")
                    flash(u"You are not authorized.", "warning")
                    return redirect(self.appbuilder.get_url_for_login)
            else:
                print("No whitelist for OAuth provider")
