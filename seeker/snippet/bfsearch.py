#date: 2025-04-01T17:06:23Z
#url: https://api.github.com/gists/6fb2b64f464dbdbcfdc4889ebfb57ebb
#owner: https://api.github.com/users/toadicus
...
def slice_array(ar: list, slice_count: int) -> Generator[list]:
...
def iterative_search(root: str, needles: list[str], max_depth: int, match_case: bool, whole_match, starting_paths: list[str]) -> None:
	...
	for item in starting_paths:
		...
		if check_needles(item, needles, match_case, whole_match): print(path)
