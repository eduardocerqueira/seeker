#date: 2022-03-17T17:10:55Z
#url: https://api.github.com/gists/31530d099bfc3002e5dba54324e9faf6
#owner: https://api.github.com/users/Zeruk
...
${PR_CYAN}${PR_ULCORNER}${PR_HBAR}${PR_YELLOW}(\
${PR_GREEN}%${PR_PWDLEN}<...<%~%<<\
${PR_YELLOW})$(ruby_prompt_info)${PR_CYAN}${PR_HBAR}${PR_HBAR}${(e)PR_FILLBAR}${PR_HBAR}${PR_YELLOW}(\
${PR_CYAN}%(!.%SROOT%s.%n) at %D{%H:%M:%S}\
${PR_YELLOW})${PR_CYAN}${PR_HBAR}${PR_URCORNER}\
