#date: 2024-08-14T19:01:42Z
#url: https://api.github.com/gists/301d666f20370412a571570ec304527c
#owner: https://api.github.com/users/bananasss00
...
class CheckpointLoaderBNB:
    ...
    def load_checkpoint(self, ckpt_name, load_clip, load_vae, bnb_dtype="default"):
        ...
        out = comfy.sd.load_checkpoint_guess_config(ckpt_path, output_vae=load_vae=="True", output_clip=load_clip=="True", embedding_directory=folder_paths.get_folder_paths("embeddings"), model_options={"custom_operations": ops})
        return out[:3]
