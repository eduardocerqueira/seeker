#date: 2026-02-12T17:42:45Z
#url: https://api.github.com/gists/1fc8dd5962f6c589efa3f10a68c8819a
#owner: https://api.github.com/users/omerfarukballi
...
def rmsnorm(x):
 ...
 "**********"d "**********"e "**********"f "**********"  "**********"g "**********"p "**********"t "**********"( "**********"t "**********"o "**********"k "**********"e "**********"n "**********"_ "**********"i "**********"d "**********", "**********"  "**********"p "**********"o "**********"s "**********"_ "**********"i "**********"d "**********", "**********"  "**********"k "**********"e "**********"y "**********"s "**********", "**********"  "**********"v "**********"a "**********"l "**********"u "**********"e "**********"s "**********") "**********": "**********"
    tok_emb = "**********"
...
for sample_idx in range(20):
    ...
    for pos_id in range(block_size):
        ...
        token_id = "**********"=[p.data for p in probs])[0]
 "**********"  "**********"  "**********"  "**********"  "**********"  "**********"  "**********"  "**********"  "**********"i "**********"f "**********"  "**********"t "**********"o "**********"k "**********"e "**********"n "**********"_ "**********"i "**********"d "**********"  "**********"= "**********"= "**********"  "**********"B "**********"O "**********"S "**********": "**********"
            break
