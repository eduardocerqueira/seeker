#date: 2021-11-02T16:55:28Z
#url: https://api.github.com/gists/a52054f14f34031f4286fc52068b6347
#owner: https://api.github.com/users/Charnelx
...
if __name__ == '__main__':
    ...
    for doc, buckets_count in lsh_buckets:
        ...
        if dist > threshold:
            print(
                f'Found duplicate with cosine dist of {dist} and buckets buckets count of {buckets_count}: {doc}'
            )
    print('\n')
