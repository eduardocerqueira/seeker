#date: 2024-05-08T17:02:58Z
#url: https://api.github.com/gists/33244783150c4f05a43f734dc69acda0
...
def main():
    parser = argparse.ArgumentParser(description='Process compressed or uncompressed sizes from a file.')
    ...
    hep.cms.label(ax=ax, data=True, loc=0, fontsize=10)
