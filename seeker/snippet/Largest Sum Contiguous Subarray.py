#date: 2021-12-17T16:57:36Z
#url: https://api.github.com/gists/5ce40840990175e6a8a5350c3a26b843
#owner: https://api.github.com/users/faryar251
...
n = len(A)
print(f"Largest Maximum Contiguous Subarray is {maxArraysum(A, n)}")
