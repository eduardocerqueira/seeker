#date: 2025-04-04T16:55:09Z
#url: https://api.github.com/gists/93352debc10d0809e174311c39efaf1e
...
def get_parameters():
    ...
    default_params = {
        # Data parameters
        'csv_file': 'ONEUSDT_GRTUSDT_1d_price_2020-03-05_to_2025-04-04.csv',  # CSV file path
        ...
        # SD Volatility filter parameters
        'sd_filter_enabled': False,  # Whether to use SD volatility filter
        ...
        # Volatility Ratio filter parameters
        'vol_ratio_enabled': True,  # Whether to use volatility ratio filter (always set to True)
        'vol_ratio_window': 20,  # Window size for vol ratio calculation
        'vol_ratio_threshold': 1.2,  # Threshold for volatility ratio
        'vol_ratio_mode': 'threshold',  # Filter mode: 'threshold', 'range', or 'balanced'
 ...
 "**********"  "**********"  "**********"  "**********"  "**********"i "**********"f "**********"  "**********"t "**********"o "**********"k "**********"e "**********"n "**********"2 "**********"_ "**********"c "**********"o "**********"l "**********": "**********"
    ...
    # Volatility Ratio filter parameters
    print("\nVolatility Ratio Filter Parameters (Always Enabled):")

    vol_ratio_window = input(f"Volatility ratio window size [{params['vol_ratio_window']}]: ")
    if vol_ratio_window:
        params['vol_ratio_window'] = int(vol_ratio_window)

    vol_ratio_threshold = input(f"Volatility ratio threshold [{params['vol_ratio_threshold']}]: ")
    if vol_ratio_threshold:
        params['vol_ratio_threshold'] = float(vol_ratio_threshold)

    vol_ratio_mode = input(f"Volatility ratio mode ({params['vol_ratio_mode']}|range|balanced): ")
    if vol_ratio_mode in ['threshold', 'range', 'balanced']:
        params['vol_ratio_mode'] = vol_ratio_mode
...
def dynamic_walk_forward_optimization(csv_file, date_col= "**********"='close_1', token2_col='close_2',
    ...
    if param_ranges is None:
        param_ranges = {
            ...
            'vol_ratio_mode': ['threshold', 'range', 'balanced']
        }
...
def optimize_parameters_dynamic_copula(df, start_date, end_date, token1_col, token2_col,
    ...
    total_combinations = (
            ...
            len(param_ranges.get('vol_ratio_threshold', [1.2])) *
            len(param_ranges.get('vol_ratio_mode', ['threshold']))
    )
        ...
        for confidence_level in param_ranges.get('confidence_level', [0.95]):
            for atr_multiplier in param_ranges.get('atr_multiplier', [2.0]):
                for atr_on_equity in param_ranges.get('atr_on_equity', [False]):
                    for vol_ratio_threshold in param_ranges.get('vol_ratio_threshold', [1.2]):
                        for vol_ratio_mode in param_ranges.get('vol_ratio_mode', ['threshold']):
                            ...
                            try:
                                ...
                                if better_metric:
                                    ...
                                    for param_name, param_value in params.items():
                                        if param_name in ['window_size', 'confidence_level', 'atr_multiplier', 'atr_on_equity', 'vol_ratio_threshold', 'vol_ratio_mode']:
 ...
 "**********"d "**********"e "**********"f "**********"  "**********"c "**********"a "**********"l "**********"c "**********"u "**********"l "**********"a "**********"t "**********"e "**********"_ "**********"v "**********"o "**********"l "**********"_ "**********"r "**********"a "**********"t "**********"i "**********"o "**********"( "**********"t "**********"o "**********"k "**********"e "**********"n "**********"1 "**********", "**********"  "**********"t "**********"o "**********"k "**********"e "**********"n "**********"2 "**********", "**********"  "**********"w "**********"i "**********"n "**********"d "**********"o "**********"w "**********"_ "**********"s "**********"i "**********"z "**********"e "**********"= "**********"2 "**********"0 "**********") "**********": "**********"
    """
    Calculate the volatility ratio between two tokens
    ...
    # Calculate volatility ratio with protection against division by zero
    vol_ratio = "**********"=token1_vol.index)  # Default to 1
    mask = "**********"
    vol_ratio[mask] = "**********"
 ...
 "**********"d "**********"e "**********"f "**********"  "**********"f "**********"i "**********"l "**********"t "**********"e "**********"r "**********"_ "**********"s "**********"i "**********"g "**********"n "**********"a "**********"l "**********"s "**********"_ "**********"b "**********"y "**********"_ "**********"v "**********"o "**********"l "**********"_ "**********"r "**********"a "**********"t "**********"i "**********"o "**********"( "**********"t "**********"o "**********"k "**********"e "**********"n "**********"1 "**********", "**********"  "**********"t "**********"o "**********"k "**********"e "**********"n "**********"2 "**********", "**********"  "**********"s "**********"i "**********"g "**********"n "**********"a "**********"l "**********"s "**********", "**********"  "**********"w "**********"i "**********"n "**********"d "**********"o "**********"w "**********"_ "**********"s "**********"i "**********"z "**********"e "**********"= "**********"2 "**********"0 "**********", "**********"  "**********"v "**********"o "**********"l "**********"_ "**********"r "**********"a "**********"t "**********"i "**********"o "**********"_ "**********"t "**********"h "**********"r "**********"e "**********"s "**********"h "**********"o "**********"l "**********"d "**********"= "**********"1 "**********". "**********"2 "**********", "**********"  "**********"m "**********"o "**********"d "**********"e "**********"= "**********"' "**********"t "**********"h "**********"r "**********"e "**********"s "**********"h "**********"o "**********"l "**********"d "**********"' "**********") "**********": "**********"
    ...
    - vol_ratio: "**********"
    - vol_filter_status: Boolean series indicating when trading is allowed (True) or filtered (False)
    """
    ...
    vol_filter_status = pd.Series(False, index=signals.index)  # Default to False (not allowed to trade)
    ...
    if mode == 'threshold':
        ...
        vol_filter_status[valid_ratio] = True
    ...
    return filtered_signals, vol_ratio, vol_filter_status
...
def backtest_with_dynamic_copula(df, start_date, end_date, token1_col, token2_col,
    ...
    vol_filter_status = pd.Series(True, index=test_data.index)  # Default to True (allowed to trade)
    ...
    # Precalculate volatility ratio
    vol_window = strategy_params.get('vol_window', 20)
    vol_ratio_threshold = strategy_params.get('vol_ratio_threshold', 1.2)
    vol_ratio_mode = strategy_params.get('vol_ratio_mode', 'threshold')

    # Calculate volatility ratio for the entire period
    vol_ratio, token1_vol, token2_vol = "**********"=vol_window)
    ...
    for i, current_date in enumerate(test_data.index):
        try:
            ...
            # Check volatility ratio filter
            # Apply filtering based on selected mode
            is_vol_filter_active = True  # Default to allow trading

            if vol_ratio_mode == 'threshold':
                # Only trade when vol_ratio exceeds threshold (either direction)
                is_vol_filter_active = (current_vol_ratio > vol_ratio_threshold) or (
                            current_vol_ratio < 1 / vol_ratio_threshold)
            elif vol_ratio_mode == 'range':
                # Only trade when vol_ratio is within a balanced range
                min_threshold = 1 / vol_ratio_threshold
                max_threshold = vol_ratio_threshold
                is_vol_filter_active = (current_vol_ratio >= min_threshold) and (current_vol_ratio <= max_threshold)
            elif vol_ratio_mode == 'balanced':
                # Only trade when both tokens have similar volatility
                is_vol_filter_active = (current_vol_ratio >= 0.8) and (current_vol_ratio <= 1.2)

            vol_filter_status.iloc[i] = is_vol_filter_active
            ...
            # Apply volatility ratio filter to new signals
            if not is_vol_filter_active and new_signal != 0 and current_position == 0:
                # If volatility filter is not active, don't enter new positions
                new_signal = 0
            ...
            if current_position == 0:  # No current position
                ...
                if stop_hit:  # Stop-loss hit
                    ...
                    # Only allow reversal if volatility filter is active
                    if is_vol_filter_active:
                        # Record existing trade
                        if current_position == 1:
                            profit_pct = (current_spread - entry_price) / abs(entry_price) - strategy_params.get(
                                'fee_pct',
                                0.001) * 2
                        else:
                            profit_pct = (entry_price - current_spread) / abs(entry_price) - strategy_params.get(
                                'fee_pct',
                                0.001) * 2
            ...
            if i > 0:
                ...
                vol_filter_status.iloc[i] = vol_filter_status.iloc[i - 1]
    ...
    if current_position != 0:
        ...
        last_vol_ratio = vol_ratio.iloc[-1] if not vol_ratio.empty else 1.0
    ...
    results = {
        ...
        'vol_filter_status': vol_filter_status,
        'vol_ratio': vol_ratio,
        'spread': spread,
        'trades': trades_df,
...
def create_dynamic_wfo_plots(is_range, oos_range, best_params, is_results, oos_results, output_dir):
    ...
    param_str = f"Window: {best_params['window_size']}, Conf: {best_params['confidence_level']}, " \
                ...
                f"Vol Ratio: {best_params.get('vol_ratio_threshold', 1.2)}"
    ...
    # 2. Volatility Ratio Plot
    if 'vol_ratio' in is_results and 'vol_ratio' in oos_results:
        fig, (ax1, ax2) = plt.subplots(2, 1, figsize=(14, 10), sharex=True)

        # Plot In-Sample volatility ratio
        is_vol_ratio = is_results['vol_ratio'] if 'vol_ratio' in is_results else None
        oos_vol_ratio = oos_results['vol_ratio'] if 'vol_ratio' in oos_results else None

        # Plot IS equity and vol ratio
        ax1.plot(is_equity.index, is_equity.values, color='blue', label=f'In-Sample Equity')
        ax1.set_ylabel('Equity Value')
        ax1.legend(loc='upper left')
        ax1.grid(True, alpha=0.3)

        if is_vol_ratio is not None and not is_vol_ratio.empty:
            ax3 = ax1.twinx()
            ax3.plot(is_vol_ratio.index, is_vol_ratio.values, color='red', alpha=0.7, linestyle='--', label='Vol Ratio')
            ax3.axhline(y=best_params.get('vol_ratio_threshold', 1.2), color='gray', linestyle=':',
                        label=f'Threshold ({best_params.get("vol_ratio_threshold", 1.2)})')
            ax3.axhline(y=1 / best_params.get('vol_ratio_threshold', 1.2), color='gray', linestyle=':',
                        label=f'Inv. Threshold ({1 / best_params.get("vol_ratio_threshold", 1.2):.2f})')
            ax3.set_ylabel('Volatility Ratio')
            ax3.legend(loc='upper right')

        # Plot OOS equity and vol ratio
        ax2.plot(oos_equity.index, oos_equity.values, color='green', label=f'Out-of-Sample Equity')
        ax2.set_ylabel('Equity Value')
        ax2.set_xlabel('Date')
        ax2.legend(loc='upper left')
        ax2.grid(True, alpha=0.3)

        if oos_vol_ratio is not None and not oos_vol_ratio.empty:
            ax4 = ax2.twinx()
            ax4.plot(oos_vol_ratio.index, oos_vol_ratio.values, color='red', alpha=0.7, linestyle='--',
                     label='Vol Ratio')
            ax4.axhline(y=best_params.get('vol_ratio_threshold', 1.2), color='gray', linestyle=':',
                        label=f'Threshold ({best_params.get("vol_ratio_threshold", 1.2)})')
            ax4.axhline(y=1 / best_params.get('vol_ratio_threshold', 1.2), color='gray', linestyle=':',
                        label=f'Inv. Threshold ({1 / best_params.get("vol_ratio_threshold", 1.2):.2f})')
            ax4.set_ylabel('Volatility Ratio')
            ax4.legend(loc='upper right')

        plt.suptitle(f"Equity and Volatility Ratio - Vol Ratio Mode: {best_params.get('vol_ratio_mode', 'threshold')}")
        plt.tight_layout()
        plt.savefig(os.path.join(output_dir, "vol_ratio_analysis.png"), dpi=150)
        plt.close()

    # 3. Copula Updates Visualization
    ...
    # 4. Trade Distribution Comparison
    ...
    # 5. Trade Analysis by Volatility Ratio (if available)
    if ('trades' in is_results and not is_results['trades'].empty and 'vol_ratio' in is_results['trades']) or \
            ('trades' in oos_results and not oos_results['trades'].empty and 'vol_ratio' in oos_results['trades']):
        try:
            # Combine IS and OOS trades
            all_trades = pd.concat([
                is_results['trades'].assign(period='In-Sample') if not is_results['trades'].empty else pd.DataFrame(),
                oos_results['trades'].assign(period='Out-of-Sample') if not oos_results[
                    'trades'].empty else pd.DataFrame()
            ])

            if not all_trades.empty and 'vol_ratio' in all_trades.columns:
                # Create vol ratio bins
                vol_ratio_bins = [0, 0.5, 0.8, 1.0, 1.2, 1.5, 2.0, 10.0]
                all_trades['vol_ratio_bin'] = pd.cut(all_trades['vol_ratio'], bins=vol_ratio_bins,
                                                     labels=['0-0.5', '0.5-0.8', '0.8-1.0', '1.0-1.2', '1.2-1.5',
                                                             '1.5-2.0', '2.0+'])

                # Group by vol ratio bin and period
                trade_by_vol_ratio = all_trades.groupby(['period', 'vol_ratio_bin']).agg({
                    'profit_pct': ['count', 'mean', 'sum'],
                    'duration': 'mean'
                })

                # Calculate win rate
                win_rates = all_trades.groupby(['period', 'vol_ratio_bin']).apply(
                    lambda x: (x['profit_pct'] > 0).mean() * 100 if len(x) > 0 else 0
                ).rename('win_rate')

                # Plot trade performance by vol ratio
                fig, (ax1, ax2) = plt.subplots(2, 1, figsize=(12, 10))

                # Convert multi-index to readable format for plotting
                performance_by_vol_ratio = pd.DataFrame({
                    'Count': trade_by_vol_ratio[('profit_pct', 'count')],
                    'Mean P&L (%)': trade_by_vol_ratio[('profit_pct', 'mean')] * 100,
                    'Win Rate (%)': win_rates
                }).reset_index()

                # Plot trade count by vol ratio
                sns_data = performance_by_vol_ratio.pivot(index='vol_ratio_bin', columns='period', values='Count')
                sns_data.plot(kind='bar', ax=ax1)
                ax1.set_title('Trade Count by Volatility Ratio')
                ax1.set_xlabel('Volatility Ratio')
                ax1.set_ylabel('Number of Trades')
                ax1.grid(True, alpha=0.3)

                # Plot mean P&L by vol ratio
                sns_data = performance_by_vol_ratio.pivot(index='vol_ratio_bin', columns='period',
                                                          values='Mean P&L (%)')
                sns_data.plot(kind='bar', ax=ax2)
                ax2.set_title('Mean P&L by Volatility Ratio')
                ...
                plt.tight_layout()
                plt.savefig(os.path.join(output_dir, "trade_by_vol_ratio.png"), dpi=150)
                plt.close()

                # Save analysis to CSV
                performance_by_vol_ratio.to_csv(os.path.join(output_dir, "trade_by_vol_ratio.csv"))

        except Exception as e:
            print(f"Warning: Could not create volatility ratio analysis plots. Error: {e}")

    # 6. Trade Analysis by Copula Type
    if 'trades' in is_results and 'trades' in oos_results:
        all_trades = pd.concat([
            is_results['trades'].assign(period='In-Sample') if not is_results['trades'].empty else pd.DataFrame(),
    ...
    # 7. Save detailed results summary as text
    with open(os.path.join(output_dir, "results_summary.txt"), 'w') as f:
        ...
        f.write("\nVOLATILITY RATIO FILTER ANALYSIS:\n")
        f.write(f"Volatility Ratio Threshold: {best_params.get('vol_ratio_threshold', 1.2)}\n")
        f.write(f"Volatility Ratio Mode: {best_params.get('vol_ratio_mode', 'threshold')}\n")
...
def create_dynamic_wfo_consolidated_visualizations(results, consolidated_metrics, output_dir):
    ...
    # 4. Create consolidated performance summary table
    ...
    # 5. Scatter plot of In-Sample vs Out-of-Sample returns
    ...
    # 6. Save consolidated metrics as a text file
...
def main():
    ...
    param_ranges = {
        ...
        'confidence_level': [0.90, 0.91, 0.92, 0.93, 0.94, 0.95, 0.99],
        'atr_multiplier': [1.5, 2.0, 2.5],
        'atr_on_equity': [False, True],
        'vol_ratio_threshold': [1.2, 1.5, 2.0],
        'vol_ratio_mode': ['threshold', 'range', 'balanced']
    ...
    print("\nNote: Volatility ratio filter is ENABLED for all strategy runs")
    print(f"Volatility ratio parameters being tested:")
    print(f"  - Thresholds: {param_ranges['vol_ratio_threshold']}")
    print(f"  - Modes: {param_ranges['vol_ratio_mode']}")
    print(f"  - Window size: {params['vol_ratio_window']} (fixed)")
