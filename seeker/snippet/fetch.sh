#date: 2022-01-28T16:53:34Z
#url: https://api.github.com/gists/dc247595ee08b2145de21340e8421518
#owner: https://api.github.com/users/afreidz
...
echo -e "     ${c3}•${c8}_${c3}•${c0}       ${c4}${c3}  ${finaldistro}"
echo -e "     ${c8}${c0}${c9}oo${c0}${c8}|${c0}       ${c5}${c3}  ${varWm}"
echo -e "    ${c8}/${c0}${c10} ${c0}${c8}'\'${c0}      ${c2}${c3}  ${SHELL##*/}"
echo -e "   ${c9}(${c0}${c8}\_;/${c0}${c9})${c0}      ${c7}${c3}  $(get_mem)"
echo -e "              ${c6}▃▃▃▃${c6}${c2}▃▃▃▃${c2}${c4}▃▃▃▃${c4}${c5}▃▃▃▃${c5}${c7}▃▃▃▃${c7}"
echo -e "               \033[0m"