#date: 2022-09-27T17:05:39Z
#url: https://api.github.com/gists/bdec0daa09d0c80f229ee3c2fbcc2a40
#owner: https://api.github.com/users/idmyn
...
echo '
 ...
 "**********"  "**********"  "**********"# "**********"  "**********"I "**********"n "**********"i "**********"t "**********"i "**********"a "**********"l "**********"  "**********"e "**********"m "**********"p "**********"t "**********"y "**********"  "**********"r "**********"o "**********"o "**********"t "**********"  "**********"p "**********"a "**********"s "**********"s "**********"w "**********"o "**********"r "**********"d "**********"  "**********"f "**********"o "**********"r "**********"  "**********"e "**********"a "**********"s "**********"y "**********"  "**********"l "**********"o "**********"g "**********"i "**********"n "**********": "**********"
  ...
  users.users.root.openssh.authorizedKeys.keys = [
    ...
    "ssh-ed25519 AAAAC3NzaC1lZDI1NTE5AAAAIGJ7fFhOQqhazv5Wh++ttjRLDt9cxNEgmHM7T1cxcX+f david@teamsurfboard.com"
  ];
}
