#date: 2024-03-06T17:10:30Z
#url: https://api.github.com/gists/358895ef0b2ffaa9e708181b16b554cf
#owner: https://api.github.com/users/hmassias
...
def upload_file(upload_url, file_path, fields, replace_file):
...
def upload_seafile(upload_page_link, file_path_list, replace_file, verbose):
    ...
    token, parent_dir, repo_id, dir_name = "**********"
    if not parent_dir:
 ...
 "**********"  "**********"  "**********"  "**********"  "**********"i "**********"f "**********"  "**********"t "**********"o "**********"k "**********"e "**********"n "**********": "**********"
    ...
    for idx, file_path in enumerate(file_path_list):
        ...
        try:
            response = upload_file(upload_url, file_path, {'parent_dir': parent_dir}, replace_file)
            if response.status_code == 200:
