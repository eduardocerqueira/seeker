#date: 2023-01-13T16:39:42Z
#url: https://api.github.com/gists/2d21ba5cb8ce3355e7479dfb0f9445c6
#owner: https://api.github.com/users/LeiWang1999
...
log_path = "progress/tensorirscript_imma/8.tricky_conv2d_fp16_fp16_nhwc_hwoc"
count = 0
...
sch.reorder(block_i, block_j, nc, oc, nci, oci, nnc, ooc)
...
sch.reverse_compute_at(block_conv_output_frag, oc)
...
sch.compute_at(block_conv_input_frag, kw)
sch.compute_at(block_conv_weight_frag, kw)
