#date: 2022-09-05T17:13:48Z
#url: https://api.github.com/gists/8bcb3294b3ede9a5e0da71ff64d8843a
#owner: https://api.github.com/users/lopes
...
function help() {
  echo "
This script fetches IP address data on 3 services (in the future we
can add more) and bring it to the engineer. Data include any
evaluation of that IP address (like poor/good,neutral), the ISP
responsible for the address, and the geolocation -if available.
