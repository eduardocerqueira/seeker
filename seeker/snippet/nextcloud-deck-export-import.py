#date: 2023-02-06T16:57:34Z
#url: https://api.github.com/gists/ac073e8751313d19b57142efdfb574b4
#owner: https://api.github.com/users/JordanNiphan
...
for board in boards:
    ...
    for stack in stacks:
        ...
        print('    Created', len(stack['cards']), 'archived cards')ds']), 'archived cards')