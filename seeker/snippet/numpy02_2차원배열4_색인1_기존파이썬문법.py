...
print("1. arr[0]", arr[0])  # 1. arr[0] [1 2 3]
print("2. arr[행, 열]", arr[0, 1])  # 2. arr[행, 열] 2

print("3. arr[행, 열: 슬라이싱]", arr[0, 1:])  # 3. arr[행, 슬라이싱] [2 3]
print("4. arr[행, 열: 팬시 색인]", arr[0, [0, 2]])  # 4. arr[행, 팬시 색인] [1 3], 팬시 색인에는 대괄호가 필수다!

print("5. arr[행: 슬라이싱, 열]", arr[1:, 1])  # 5. arr[행: 슬라이싱, 열] [5 8]
print("6. arr[행: 팬시 색인, 열]", arr[[0, 2], 1])  # 6. arr[행: 팬시 색인, 열] [2 8]

print("7. arr[행: 슬라이싱, 열: 슬라이싱]", arr[1:, :2])  # 7. arr[행: 슬라이싱, 열: 슬라이싱] [[4 5], [7 8]]
