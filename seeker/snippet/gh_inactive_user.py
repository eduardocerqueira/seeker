#date: 2022-10-03T17:26:31Z
#url: https://api.github.com/gists/2df0b2fe934d7b0317b4e1797bff7ca3
#owner: https://api.github.com/users/bugcy013
...
parser.add_argument('-u',metavar='USER', dest='github_user', action='store', required=False,
    help='GitHub user',
    default=None)
parser.add_argument('-p',metavar= "**********"='github_pass', action='store', required=False,
    help= "**********"
    default=None)
