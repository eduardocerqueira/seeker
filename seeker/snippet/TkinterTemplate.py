#date: 2024-01-01T16:47:44Z
#url: https://api.github.com/gists/f3760a7a7a02616c4d777c21b12fa25c
#owner: https://api.github.com/users/dtietje
...
class LoginPage(tk.Tk):
 ...
 "**********"  "**********"  "**********"  "**********"  "**********"  "**********"  "**********"  "**********"  "**********"d "**********"e "**********"f "**********"  "**********"v "**********"a "**********"l "**********"i "**********"d "**********"a "**********"t "**********"e "**********"( "**********"u "**********"s "**********"e "**********"r "**********"n "**********"a "**********"m "**********"e "**********", "**********"  "**********"p "**********"a "**********"s "**********"s "**********"w "**********"o "**********"r "**********"d "**********") "**********": "**********"
            # Checks the text file for a username/password combination.
            try:
                with open("credentials.txt", "r") as credentials:
                    for line in credentials:
                        line = line.split(",")
 "**********"  "**********"  "**********"  "**********"  "**********"  "**********"  "**********"  "**********"  "**********"  "**********"  "**********"  "**********"  "**********"  "**********"  "**********"  "**********"  "**********"  "**********"  "**********"  "**********"  "**********"  "**********"  "**********"  "**********"  "**********"i "**********"f "**********"  "**********"l "**********"i "**********"n "**********"e "**********"[ "**********"1 "**********"] "**********"  "**********"= "**********"= "**********"  "**********"u "**********"s "**********"e "**********"r "**********"n "**********"a "**********"m "**********"e "**********"  "**********"a "**********"n "**********"d "**********"  "**********"l "**********"i "**********"n "**********"e "**********"[ "**********"3 "**********"] "**********"  "**********"= "**********"= "**********"  "**********"p "**********"a "**********"s "**********"s "**********"w "**********"o "**********"r "**********"d "**********": "**********"
                            return True
                    return False
