#date: 2024-06-10T16:51:23Z
#url: https://api.github.com/gists/b209b4aedf46152dcf1823e230d6dd93
#owner: https://api.github.com/users/kurttu4
...
def diffuse(
    ...
    uncond_input = "**********"="max_length", max_length=max_length, return_tensors="pt")
...
def run(
    ...
    text_input = "**********"="max_length", max_length=pipe.tokenizer.model_max_length, truncation=True, return_tensors="pt")
