#date: 2025-09-03T17:10:10Z
#url: https://api.github.com/gists/efbfa3e0d2e8ddd21482be9fe25a9473
#owner: https://api.github.com/users/jonathanagustin
...
sed -i "s/password= "**********"=\"${pgpassword}\"/" tak/CoreConfig.xml
...
printf $danger "Admin password: "**********"
printf $danger "PostgreSQL password: "**********"
printf $danger "---------PASSWORDS----------------\n\n"
