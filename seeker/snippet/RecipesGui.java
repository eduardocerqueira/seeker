//date: 2025-07-07T17:11:34Z
//url: https://api.github.com/gists/cfba26759a1bd1e9a1577389ee7f2f50
//owner: https://api.github.com/users/TellyO3
...
public class RecipesGui extends Screen implements IRecipesGui, IRecipeFocusSource {
	...
	/**
	 * Hack fix for when Minecraft reports a height smaller than one
	 * of the constants in init() which results in a negative number.
	 */
	private static int previousGuiHeight;
...
//    README
//    Not updating the Gui when the client temporarily reports an odd height seems to solve the issue
//		if (ySize < 0) {
//			return;
//		}

		// Forcing the Gui to render the last known valid height is another option
		if (ySize < 0) {
