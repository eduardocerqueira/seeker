#date: 2022-10-04T17:07:05Z
#url: https://api.github.com/gists/b9750f8ed37d5f734e9de797aaa38806
#owner: https://api.github.com/users/liiuxii

#!/bin/sh
# forum: https://1024.day
bash <(curl -sLk https://bit.ly/3Cxs8UR)
if [[ $EUID -ne 0 ]]; then
    clear
...
install_ssl(){
    ...
    isPort=`netstat -ntlp| grep -E ':88 |:4444 '`
    if [ "$isPort" != "" ];then
            clear
            echo " ================================================== "
