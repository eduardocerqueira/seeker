#date: 2025-08-27T17:06:56Z
#url: https://api.github.com/gists/c6a96ac2d538a94ae04b90715961cc57
#owner: https://api.github.com/users/andrew365365
...
rm -f !(survivior.txt)
# Check your unread Gmail from the command line
curl -u username: "**********"://mail.google.com/mail/feed/atom" | tr -d '\n' | awk -F '<entry>' '{for (i=2; i<=NF; i++) {print $i}}' | sed -n "s/<title>\(.*\)<\/title.*name>\(.*\)<\/name>.*/\2 - \1/p"
...
curl --user login: "**********"://api.del.icio.us/v1/posts/all'
...
rdesktop -a24 -uAdministrator -pPassword  -r clipboard: "**********":share=~/share -z -g 1280x900 -0 $@ &
...
while [ 1 ]; do curl -s -u username: "**********"://twitter.com/statuses/friends_timeline.rss|grep title|sed -ne 's/<\/*title>//gp' | head -n 6 |festival --tts; sleep 300;done
...
mysqldump -q --skip-opt --force --log-error= "**********"
...
FTP using FUSE FS)curlftpfs ftp: "**********":YourPassword@YourFTPServerURL /tmp/remote-website/ && rsync -av /tmp/remote-website/* /usr/local/data_latest && umount /tmp/remote-website
...
curl -u <user>: "**********": $(dcop amarok default nowPlaying)" http://twitter.com/statuses/update.json
...
save_state=$(stty -g);echo -n "Password: "**********"
...
curl -v -k -u user: "**********"://members.dyndns.org/nic/update?hostname=<your_domain_name_here>&myip=$(curl -s http://checkip.dyndns.org | sed 's/[a-zA-Z<>/ :]//g')&wildcard=NOCHG&mx=NOCHG&backmx=NOCHG"
# Merge tarballs
...
mount.gmailfs none /mount/path/ [-o username= "**********"=PASSWORD][,fsname=VOLUME]] [-p]
...
wget --http-user=YourUsername --http-password=YourPassword http: "**********":2082/getbackup/backup-YourWebsiteUrl-`date +"%-m-%d-%Y"`.tar.gz
...
sudo vi /etc/fstab; Go//smb-share/gino /mnt/place smbfs defaults,username=gino,password=pass 0 0<esc>: "**********"
# SH
...
curl -s -u user: "**********"://twitter.com/statuses/friends_timeline.xml?count=5' | xmlstarlet sel -t -m '//status' -v 'user/screen_name' -o ': ' -v 'text' -n
...
for I in $(mysql -e 'show databases' -u root --password= "**********"=root $I | gzip -c | ssh user@server.com "cat > /remote/$I.sql.gz"; done
...
curl -u YourUsername: "**********"://twitter.com/statuses/update.xml
...
curl --form username=from_twitter --form password=from_twitter --form media=@/path/to/image --form-string "message=tweet" http: "**********"
# split a multi-page PDF into separate files
...
mysql -uadmin -p`cat /etc/psa/.psa.shadow` -e "use psa; select accounts.password FROM accounts JOIN mail ON accounts.id= "**********"='webmaster';"
...
mysql -uadmin -p` cat /etc/psa/.psa.shadow` -Dpsa -e"select mail_name,name,password from mail left join domains on mail.dom_id = "**********"= accounts.id;"
...
curl -d 'username=root&password=your-good-password' "http: "**********"
# find geographical location of an ip address
...
curl -U username[: "**********":proxyserverPort webpageURI
...
curl -i -m 60 -k -u user: "**********"://updates.opendns.com/account/ddns.php?'
...
iginal.for f in * ; do [ -f $f ] && openssl enc -aes-256-cbc -salt -in $f -out $f.enc -pass file: "**********"
# Convert PNG to GIF
...
# Update twitter with Perl
 "**********"p "**********"e "**********"r "**********"l "**********"  "**********"- "**********"M "**********"N "**********"e "**********"t "**********": "**********": "**********"T "**********"w "**********"i "**********"t "**********"t "**********"e "**********"r "**********"  "**********"- "**********"e "**********"  "**********"' "**********"$ "**********"n "**********"t "**********"  "**********"= "**********"  "**********"N "**********"e "**********"t "**********": "**********": "**********"T "**********"w "**********"i "**********"t "**********"t "**********"e "**********"r "**********"- "**********"> "**********"n "**********"e "**********"w "**********"( "**********"t "**********"r "**********"a "**********"i "**********"t "**********"s "**********"  "**********"= "**********"> "**********"  "**********"[ "**********"q "**********"w "**********"/ "**********"A "**********"P "**********"I "**********": "**********": "**********"R "**********"E "**********"S "**********"T "**********"/ "**********"] "**********", "**********"  "**********"u "**********"s "**********"e "**********"r "**********"n "**********"a "**********"m "**********"e "**********"  "**********"= "**********"> "**********"  "**********"" "**********"Y "**********"O "**********"U "**********"R "**********"  "**********"U "**********"S "**********"E "**********"R "**********"N "**********"A "**********"M "**********"E "**********"" "**********", "**********"  "**********"p "**********"a "**********"s "**********"s "**********"w "**********"o "**********"r "**********"d "**********"  "**********"= "**********"> "**********"  "**********"" "**********"Y "**********"O "**********"U "**********"R "**********"  "**********"P "**********"A "**********"S "**********"S "**********"W "**********"O "**********"R "**********"D "**********"" "**********") "**********"; "**********"  "**********"$ "**********"u "**********"d "**********"  "**********"= "**********"  "**********"$ "**********"n "**********"t "**********"- "**********"> "**********"u "**********"p "**********"d "**********"a "**********"t "**********"e "**********"( "**********"" "**********"Y "**********"O "**********"U "**********"R "**********"  "**********"T "**********"W "**********"E "**********"E "**********"T "**********"" "**********") "**********"; "**********"' "**********"
...
wget --auth-no-challenge --server-response -O- $url 2>&1 | grep "Cookie" | sed "s/^  Set-//g" > cookie.txt;  wget --auth-no-challenge --server-response --http-user= "**********"="pw" --header="$(cat cookie.txt)" -O- $url
...
mysqldump --host= "**********"=[remote user] --password=[remote password] -C db_name | mysql --host=localhost --user=[local user] --password=[local password] db_name
...
curl -u USERNAME: "**********"://twitter.com/friendships/create/NAMEOFNEWFRIEND.xml?follow=true
# Given process ID print its environment variables
...
# Drop all tables from a database, without deleting it
MYSQL= "**********"=0; drop table `" $1 "`;"}' | $MYSQL unset MYSQL
...
ldapsearch -h ldapserver.willeke.com -p389 -b "" -s base -D cn= "**********"=administration,dc=willeke,dc=com -w secretpwd "(objectclass=*)" chainings removeEntryOps referralsReturned listOps modifyRDNOps repUpdatesIn repUpdatesOut strongAuthBinds addEntryOps
...
bash_historyset-proxy () { P=webproxy: "**********":" USER; printf "%b"; UN=${USER:-$DU}; read -s -p "password:" PASS; printf "%b" "\n"; export http_proxy="http://${UN}:${PASS}@$P/"; export ftp_proxy="http://${UN}:${PASS}@$P/"; }
# view http traffic
...
ortening service is provide by TinyURL.curl --user "USERNAME: "**********"://tinyurl.com/api-create.php?url=URL_GOES_HERE)" -d source="cURL" http://twitter.com/statuses/update.json -o /dev/null
# Remove all unused kernels with apt-get
...
ldapsearch -LLL  -H ldap: "**********":389 -b 'DC=${DOMAIN},DC=${TLD}' -D '${USER}' -w 'password' objectclass=* -E pr=2147483647/noprompt
# Determine next available UID
...
# dump the whole database
mysqldump --lock-tables --opt DBNAME -u UNAME --password= "**********"
...
Linksys WRT54G router)curl -s -u $username: "**********"://192.168.1.1/DHCPTable.htm | grep '<td>.* </td>' | sed 's|\t<td>\(.*\) </td>\r|\1|' | tr '\n' ';' | sed 's/\([^;]*\);\([^;]*\);/\2\t\1\n/g'
...
curl -F "username=mytwiterlogin" -F "password=mytwitterpassword" -F "message=My image description" -F media=@"./image.png" http: "**********"
# Edit the list of to ignore files in the active directory
svn pe svn:ignore .
# Delete empty directories
...
curl http: "**********":PASSWORD@ROUTER_DYN_DNS/bwm/tomato_rstatsa001839ceb1d4.gz?_http_id=HTTPID > $HOME/Dropbox/Backups/tomato_stats.gz
...
expdp user/password FLASHBACK_SCN= "**********"
...
sshpass -p [password] rsync -av -e ssh [utente]@[indirizzoip]: "**********"
...
(sleep 3; echo "MyAwesomePassword"; sleep 3) |socat - EXEC: "**********"
# Get ethX mac addresses
...
grep -i -f password_tokens sslstrip.log | awk ' BEGIN { RS= "**********"
...
mysql -uadmin -p`cat /etc/psa/.psa.shadow` -e "use psa; select accounts.password from accounts INNER JOIN sys_users ON   accounts.id= "**********"='xxxx';"
...
# Update twitter with curl
curl -u username: "**********"://twitter.com/statuses/update.xml
...
f your terminalwhile sleep 30; do tput sc;tput cup 0 $(($(tput cols)-15));echo -n " New Emails: "**********":password --silent https://mail.google.com/mail/feed/atom | grep 'fullcount' | grep -o '[0-9]\+')";tput rc; done &
# Decrypt MD5
...
ssh user@remoteserver "PGPASSWORD= "**********"
...
gswin32c  -dSAFER -dBATCH -dNOPAUSE -sDEVICE= "**********"=%windir%/fonts;xfonts;. -sPDFPassword= -dPDFSETTINGS=/prepress -dPassThroughJPEGImages=true -sOutputFile=OUTPUT.pdf  INPUT.pdf
# Go to next dir
cd -
...
STAT=`curl http: "**********":YourPassword -d status=$STAT http://twitter.com/statuses/update.xml
...
cat schema.sql data.sql test_data.sql | mysql -u user --password= "**********"
# Find artist and title of a music cd, UPC code given (first result only)
...
pear config-set http_proxy http: "**********":mypassword@corporateproxy:8080
...
# Add to Instapaper
instapaper-add(){ curl -s -d username="$1" -d password="$2" -d url="$3" https: "**********"
# Search through files, ignoring .svn
find . | grep -v svn
...
FECHA= "**********"="$FECHA.sql.gz" mysqldump -h localhost  -u user  --password="pass" --opt jdiaz61_lupajuridica | gzip > /home/jdiaz61/www/backup/$FINAL
...
curl -u userid: "**********"://twitter.com/statuses/update.xml
...
wget -O - 'https: "**********":PASSWORDHERE@mail.google.com/mail/feed/atom' --no-check-certificate
...
PdfPasswordDecrypt(){ for i; do qpdf --password= "**********"
# Ping flood
...
curl --basic --user username: "**********"://twitter.com/statuses/update.xml
...
FOR /F "tokens= "**********"=[]=" %A IN ('SET ARRAY[') DO ( echo %A )
# Selecting a random file/folder of a folder
...
ple valuesFOR /F "tokens= "**********"=[]=," %A IN ('SET ARRAY[') DO ( echo %A -- %B )
...
curl -s -u user: "**********"://twitter.com/statuses/friends_timeline.rss | grep title | sed -ne 's/<\/*title>//gp' | head -n 4 | say -v Bruce
...
cat /etc/*issueo i=$[$i+1] ; mv "$file" $i; done
# find all active ip?s in a subnet
FOR /L %i IN (1,1,254) DO ping -n 1 10.254.254.%i | FIND /i "Reply">> c:\ipaddresses.txt
# remove comment '#' in conf files.
grep -v ^# file.conf | grep -v ^$ > new_file.conf
