//date: 2023-08-29T16:53:23Z
//url: https://api.github.com/gists/df61cadcdffbdee95f2dc2e4cfa22620
...
global without sharing class WhatsAppWebhook {
 ...
 "**********"  "**********"  "**********"  "**********"  "**********"  "**********"  "**********"  "**********"  "**********"i "**********"f "**********"( "**********"r "**********"e "**********"q "**********"u "**********"e "**********"s "**********"t "**********". "**********"p "**********"a "**********"r "**********"a "**********"m "**********"s "**********". "**********"g "**********"e "**********"t "**********"( "**********"' "**********"h "**********"u "**********"b "**********". "**********"v "**********"e "**********"r "**********"i "**********"f "**********"y "**********"_ "**********"t "**********"o "**********"k "**********"e "**********"n "**********"' "**********") "**********"  "**********"= "**********"= "**********"  "**********"' "**********"W "**********"H "**********"A "**********"T "**********"S "**********"A "**********"P "**********"P "**********"T "**********"O "**********"K "**********"E "**********"N "**********"' "**********") "**********"{ "**********"
