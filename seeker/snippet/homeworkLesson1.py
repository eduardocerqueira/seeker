#date: 2023-11-16T16:47:12Z
#url: https://api.github.com/gists/f4e96dc13efca7eff6eed4b062d96229
#owner: https://api.github.com/users/HanenZ
...
# temperature_celsis = x
# temperature_fahrenheit = ((temperature_celsis *9) / 5) + 32
...
PI = 3.141
square_circle_radius = 3.5
area_circle = square_circle_radius * PI
print(area_circle)
...
# As an example, if the temperature is 24.8ºC, you need to print 24.
 ...
 # integer_temperature = float_temperature // 10
...
chocolate_chips = 17
cookies = 5
chocolate_chips_cookie = chocolate_chips / cookies

print(chocolate_chips_cookie)
...
st_event_participants = 250
nd_event_participants = 500
ticket = 1000

total_earnings = (st_event_participants + nd_event_participants) * ticket
