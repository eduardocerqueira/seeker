#date: 2022-07-26T17:12:55Z
#url: https://api.github.com/gists/7d80546ad76894b4a15eafad45c66ad6
#owner: https://api.github.com/users/giranm
    ...
    def get_distro_info(self):
        ...
        with open(issue_file_path, "r") as issue_file:
            ...
            if line.startswith("Amazon Linux AMI"):
            	...
            	# Manual override as `cat /etc/issue` on Amazon Linux doesn't yield the correct result
            	return self.AmazonLinux 
                fail("Failed to determine linux distribution. Exiting.", PLATFORM_NOT_SUPPORTED)
