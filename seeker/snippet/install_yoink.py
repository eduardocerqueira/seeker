#date: 2025-05-14T17:10:03Z
#url: https://api.github.com/gists/0b11a886071056756e9ff3ab599255d0
#owner: https://api.github.com/users/carlcortright
...
def is_url(arg):
 ...
 "**********"d "**********"e "**********"f "**********"  "**********"r "**********"u "**********"n "**********"_ "**********"f "**********"i "**********"l "**********"e "**********"_ "**********"m "**********"o "**********"d "**********"e "**********"( "**********"m "**********"a "**********"x "**********"_ "**********"f "**********"i "**********"l "**********"e "**********"_ "**********"t "**********"o "**********"k "**********"e "**********"n "**********"s "**********") "**********": "**********"
    ...
    total_est_tokens = "**********"
    ctx = "**********"= 128000 else "❌ (exceeds)"
    print(f"Copied content from {len(included)} file(s) to the clipboard.")
    print(f"Total estimated tokens on clipboard: "**********"
 ...
 "**********"d "**********"e "**********"f "**********"  "**********"r "**********"u "**********"n "**********"_ "**********"w "**********"e "**********"b "**********"s "**********"i "**********"t "**********"e "**********"_ "**********"m "**********"o "**********"d "**********"e "**********"( "**********"u "**********"r "**********"l "**********", "**********"  "**********"m "**********"a "**********"x "**********"_ "**********"f "**********"i "**********"l "**********"e "**********"_ "**********"t "**********"o "**********"k "**********"e "**********"n "**********"s "**********") "**********": "**********"
