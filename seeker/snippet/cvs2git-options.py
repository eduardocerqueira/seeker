#date: 2023-07-14T16:46:01Z
#url: https://api.github.com/gists/66fb8132888860f67f86b56c791edf53
#owner: https://api.github.com/users/savornicesei
...
ctx.revision_collector = GitRevisionCollector(
    ...
    # OutputPass:
    blob_filename=os.path.join(ctx.tmpdir, 'blob.dat'),
	#blob_filename='blob',
    )
...
author_transforms={
    'dkackman' : ('Don Kackman', 'dkackman@gmail.com'),
    'dlrohm' : ('Doug Rohm', 'dlrohm@users.sourceforge.net'),
    'drieseng' : ('Gert Driesen', 'driesen@users.sourceforge.net'),
    'injektilo' : ('Jason Diamond', 'injektilo@users.sourceforge.net'),
    'jcman' : ('Jean-Claude Manoli', 'jcman@users.sourceforge.net'),
	'jcarneiro' : ('John Carneiro', 'jcarneiro@users.sourceforge.net'),
	'kdowns' : ('Kevin Downs', 'kdowns@users.sourceforge.net'),
	'kraldon' : ('Kral Ferch', 'kraldon@users.sourceforge.net'),
	'mhjp' : ('Michael Poettgen', 'mhjp@users.sourceforge.net'),
	'mwaltuch' : ('Michael Waltuch', 'mwaltuch@users.sourceforge.net'),
	'megazoid81' : ('Vishy', 'megazoid81@users.sourceforge.net'),
	'anonymous': ('Unknown', 'anonymous@users.sourceforge.net'),
	'hildjj': ('Joe Hildebrand', 'hildjj@users.sourceforge.net' ),
	'jens-chr': ('Jens-Christian Korth', 'jens-chr@users.sourceforge.net' ),
	'rseghers': ('Ryan Seghers', 'rseghers@users.sourceforge.net' ),
	'cdrnet': ('Christoph Ruegg', 'cdrnet@users.sourceforge.net' ),
	'jeromu': ('Jerome Mathieu', 'jeromu@users.sourceforge.net' ),
	'tumtum': ('06th2d', 'tumtum@users.sourceforge.net' ),
	'svanesch': ('svanesch', 'svanesch@users.sourceforge.net' ),
	'uid56059': ('uid56059', 'uid56059@users.sourceforge.net' ),
	'clubstew': ('clubstew', 'clubstew@users.sourceforge.net' ),
	'gerry_shaw': ('Gerry Shaw', 'gerry_shaw@users.sourceforge.net' ),
	'carlosga_fb': ('Carlos Guzman Alvarez', 'carlosga_fb@users.sourceforge.net' ),
	'oxnoxo': ('Nappo', 'oxnoxo@users.sourceforge.net' ),
	'laurentdomenech': ('Laurent Domenech', 'laurentdomenech@users.sourceforge.net' ),
	'nickmsn2': ('nickmsn2', 'nickmsn2@users.sourceforge.net' ),
	'andiselle': ('Andreas Selle', 'andiselle@users.sourceforge.net' ),
	'skot': ('Scott Hernandez', 'skot@users.sourceforge.net' ),
	'arobinson74': ('Andrew Robinson', 'arobinson74@users.sourceforge.net' ),
	'myleftfoot': ('lefty', 'myleftfoot@users.sourceforge.net' ),
	

    # This one will be used for commits for which CVS doesn't record
    # the original author, as explained above.
    'cvs2git' : 'cvs2git <none@users.sourceforge.net>',
    }
