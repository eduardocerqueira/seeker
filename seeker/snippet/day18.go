//date: 2023-12-18T16:58:24Z
//url: https://api.github.com/gists/b4028489947335ca5b01af54506bdac7
//owner: https://api.github.com/users/rtkwlf-hzzz
...
func day18Part1(input []string) int {
	...
	for i := 0; i < len(matrix); i++ {
		for j := 0; j < len(matrix[0]); j++ {
			if matrix[i][j] == '#' || Contains(indexArray, matrix[i][j]) {
				res += 1
			}
		}
	}
...
func Contains(input []byte, target byte) bool {
