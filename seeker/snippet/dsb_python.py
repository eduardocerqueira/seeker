#date: 2025-02-21T17:04:19Z
#url: https://api.github.com/gists/8e30c924302c1c8670fd1123d57d54d6
...
def dsb_adapted(adata_filtered: ad.AnnData, adata_raw: ad.AnnData, 
               pseudocount: int = 10, denoise_counts: bool = True, 
               use_isotype_controls: bool = None, add_layer: bool = True) -> ad.AnnData:
    """
    ...
    cell_protein_matrix = pd.DataFrame(cell_protein_matrix, 
                                    index=adata_filtered.obs_names, 
                                    columns=adata_filtered.var_names)

    empty_drop_matrix = pd.DataFrame(empty_drop_matrix, 
                                    index=empty_barcodes, 
