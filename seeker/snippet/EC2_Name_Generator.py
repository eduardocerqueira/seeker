#date: 2024-04-29T16:52:58Z
#url: https://api.github.com/gists/1a6f49d9f3d6e9068c333597d4acd20d
#owner: https://api.github.com/users/geast16
...
def generate_ec2_names(num_instances, department):
    ...
    if department.capitalize() not in valid_departments:
        print("Invalid department. Please choose from Marketing, Accounting, or FinOps.")
        return
    
    # Generate unique names for the given number of instances
    ec2_names = []
    for i in range(1, num_instances + 1):
        ec2_name = f"{department.capitalize()}-Instance{i}-{generate_random_string()}"
