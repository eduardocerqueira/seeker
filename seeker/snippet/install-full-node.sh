#date: 2022-03-22T17:18:22Z
#url: https://api.github.com/gists/b38ec3916f2a010d72a177e5999dc6ec
#owner: https://api.github.com/users/VitalFM
...
check_bitcoin_core() {
    if [ -f $TARGET_DIR/.bitcoin/bitcoind.pid ]; then
        ...
        reachable=$(curl -I https://bitnodes.earn.com/api/v1/nodes/me-$PORT/ 2> /dev/null | head -n 1 | cut -d ' ' -f2)
