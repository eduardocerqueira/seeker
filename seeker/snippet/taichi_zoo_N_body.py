#date: 2021-09-28T17:04:35Z
#url: https://api.github.com/gists/53a89eda41ddd6abbbe852b4dc574124
#owner: https://api.github.com/users/zhangsz1998
...
while gui.running:
    ...
    gui.clear(0x112F41)
    gui.circles(pos.to_numpy(), color=0x0, radius=planet_radius)
    gui.show()