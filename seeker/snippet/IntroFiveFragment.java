...
public class IntroFiveFragment extends Fragment {
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        //set content
        title.setText(getContext().getString(R.string.intro_ready_title));
        Glide.with(getContext())
                .load(getContext().getDrawable(R.drawable.ic_intro_ready))
                .into(icon);

        content.setText(getContext().getString(R.string.intro_ready_description));
    }
}