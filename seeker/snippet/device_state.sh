#date: 2021-10-08T17:08:35Z
#url: https://api.github.com/gists/eed1cde6e6979d86134899fe7f058b00
#owner: https://api.github.com/users/mchoji
...
get_os_name_and_version() {
  ...
  if [ -r "$OS_INFO_FILE" ]; then
    ...
    case "$OS_NAME" in
      *ubuntu*|*debian*|*arch*|*fedora*|*manjaro*|*pop*)
        OS_VERSION=$(uname -r)
        ;;
      *)
        ;;
