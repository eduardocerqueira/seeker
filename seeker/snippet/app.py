#date: 2022-03-30T16:53:41Z
#url: https://api.github.com/gists/b4533e23650ece929753f63c441bbe3e
#owner: https://api.github.com/users/rick200213
...
app.layout = html.Div(children=[
    ...
    # Enter your code below. Make sure you have correct formatting.
            html.H1('US Domestic Flight Performance',
...
def get_graph(chart, year, children1, children2, c3, c4, c5):
    ...
    if chart == 'OPT1':
        ...
        # Enter your code below. Make sure you have correct formatting.
        line_fig = px.line(line_data, x='Month', y='AirTime', color='Reporting_Airline', title='Average monthly flight time (minutes) by airlines')
