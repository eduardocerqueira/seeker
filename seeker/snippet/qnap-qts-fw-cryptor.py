#date: 2024-04-19T16:45:54Z
#url: https://api.github.com/gists/38de42b161267ebcadbcc66ef560c417
#owner: https://api.github.com/users/robbert1978
...
def main(*argv):
 ...
 "**********"d "**********"e "**********"f "**********"  "**********"d "**********"o "**********"_ "**********"e "**********"n "**********"c "**********"r "**********"y "**********"p "**********"t "**********"( "**********"s "**********"e "**********"c "**********"r "**********"e "**********"t "**********", "**********"  "**********"p "**********"r "**********"e "**********"f "**********"i "**********"x "**********"l "**********"e "**********"n "**********", "**********"  "**********"i "**********"n "**********"p "**********"u "**********"t "**********"f "**********"i "**********"l "**********"e "**********", "**********"  "**********"o "**********"u "**********"t "**********"p "**********"u "**********"t "**********"f "**********"i "**********"l "**********"e "**********") "**********": "**********"
    SEEK_END = 2
 ...
 "**********"d "**********"e "**********"f "**********"  "**********"d "**********"o "**********"_ "**********"d "**********"e "**********"c "**********"r "**********"y "**********"p "**********"t "**********"( "**********"s "**********"e "**********"c "**********"r "**********"e "**********"t "**********", "**********"  "**********"i "**********"n "**********"p "**********"u "**********"t "**********"f "**********"i "**********"l "**********"e "**********", "**********"  "**********"o "**********"u "**********"t "**********"p "**********"u "**********"t "**********"f "**********"i "**********"l "**********"e "**********") "**********": "**********"
    SEEK_END = 2
    inputfile.seek(0, SEEK_END)
    filesize = inputfile.tell()
...
class Cryptor:
 "**********"  "**********"  "**********"  "**********"  "**********"d "**********"e "**********"f "**********"  "**********"_ "**********"_ "**********"i "**********"n "**********"i "**********"t "**********"_ "**********"_ "**********"( "**********"s "**********"e "**********"l "**********"f "**********", "**********"  "**********"s "**********"e "**********"c "**********"r "**********"e "**********"t "**********") "**********": "**********"
        self.secret = "**********"
        self.n = "**********"
        if self.n % 2 == 0:
