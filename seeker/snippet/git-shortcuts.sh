#date: 2025-08-11T16:58:08Z
#url: https://api.github.com/gists/6ec5fcc5567f4dbb03b171d455585fcc
...
glo='git push && gh pr create --fill && gh pr merge -sd --admin'
globurl='noglob urlglobber '
glod='git log --graph --pretty="%Cred%h%Creset -%C(auto)%d%Creset %s %Cgreen(%ad) %C(bold blue)<%an>%Creset"'
glodev='git push && gh pr create --fill -B dev && gh pr merge -md --admin'
...
gprc='git push && gh pr create --fill'
gprcdev='git push && gh pr create --fill -B dev'
