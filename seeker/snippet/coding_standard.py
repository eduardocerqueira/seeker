#date: 2022-06-30T16:52:34Z
#url: https://api.github.com/gists/b38d238e8063bd9d31cc71c50122a533
#owner: https://api.github.com/users/dPys
...
def my_function(x: float, y: float, z: float) -> float:
...
class FooBar(Baz):
    ...
    def my_function(self, x: float, y: float, z: float) -> float:
        """ A method definition must contain a docstring. """
...
def complex(real: float, imag: float=0.0) -> float:
