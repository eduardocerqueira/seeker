#date: 2023-08-01T16:56:14Z
#url: https://api.github.com/gists/62d46477afa97ba0fc59f39700fbc2af
#owner: https://api.github.com/users/lewtun
...
class ScriptArguments:
    ...
    kl_penalty: Optional[str] = field(
        default="kl",
        metadata={
            "help": "**********": 'kl': model_logp - ref_logp,  'abs': abs(kl),  'mse': mean squared error mse(kl) and 'full': the actual kl for all tokens in the distribution"
        },
    )
...
def build_dataset(config, dataset_name="imdb", input_min_text_length=2, input_max_text_length=8):
 ...
 "**********"  "**********"  "**********"  "**********"  "**********"d "**********"e "**********"f "**********"  "**********"t "**********"o "**********"k "**********"e "**********"n "**********"i "**********"z "**********"e "**********"( "**********"s "**********"a "**********"m "**********"p "**********"l "**********"e "**********") "**********": "**********"
...
ppo_trainer = "**********"=dataset, data_collator=collator)
