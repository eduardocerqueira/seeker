...
public class IntroThreeFragment extends Fragment {
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        //set content
        title.setText(getContext().getString(R.string.intro_store_title));
        Glide.with(getContext())
                .load(getContext().getDrawable(R.drawable.ic_intro_store))
                .into(icon);

        content.setText(getContext().getString(R.string.intro_store_description));
    }
}