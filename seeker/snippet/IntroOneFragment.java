...
public class IntroOneFragment extends Fragment {
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        //set content
        title.setText(getContext().getString(R.string.intro_identify_title));
        Glide.with(getContext())
                .load(getContext().getDrawable(R.drawable.ic_intro_identify))
                .into(icon);

        content.setText(getContext().getString(R.string.intro_identify_description));
    }
}