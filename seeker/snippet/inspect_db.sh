#date: 2025-05-27T17:05:31Z
#url: https://api.github.com/gists/822d261df73b4c3587b1328a8ce888bf
...
if [ "$(whoami)" != "postgres" ]; then
  echo "This script needs to run as the postgres user. Re-executing with sudo..."
