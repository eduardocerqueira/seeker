#date: 2022-06-02T16:57:14Z
#url: https://api.github.com/gists/df95787e1be289cd06b0c90686f21c7f
...
sys.path.append('/home/vivek/vivek/work/v-diffusion-pytorch')
...
model.load_state_dict(torch.load('/home/vivek/vivek/work/v-diffusion-pytorch/checkpoints/cc12m_1_cfg.pth', map_location='cpu'))
