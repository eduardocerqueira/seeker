#date: 2024-07-09T17:12:31Z
#url: https://api.github.com/gists/55063a19cf0243bc521bd854185226c0
#owner: https://api.github.com/users/SF9040
...
def transformer(in_tokens: "**********": TransformerWeights):
    x = "**********"
    b, t, d = x.shape
...
if __name__ == "__main__":
    ...
    in_tokens = "**********"="pt")["input_ids"].to("cuda")
    for _ in range(10):
        out = "**********"
