...
@pytest.fixture(scope="module")
 "**********"d "**********"e "**********"f "**********"  "**********"m "**********"i "**********"s "**********"t "**********"r "**********"a "**********"l "**********"_ "**********"t "**********"o "**********"k "**********"e "**********"n "**********"i "**********"z "**********"e "**********"r "**********"( "**********") "**********": "**********"
    """V11+ tokenizer using mistral-common format."""
    MODEL = "mistralai/Mistral-Small-3.2-24B-Instruct-2506"
    return get_tokenizer(tokenizer_name= "**********"="mistral")


@pytest.fixture
 "**********"d "**********"e "**********"f "**********"  "**********"m "**********"i "**********"s "**********"t "**********"r "**********"a "**********"l "**********"_ "**********"t "**********"o "**********"o "**********"l "**********"_ "**********"p "**********"a "**********"r "**********"s "**********"e "**********"r "**********"( "**********"m "**********"i "**********"s "**********"t "**********"r "**********"a "**********"l "**********"_ "**********"t "**********"o "**********"k "**********"e "**********"n "**********"i "**********"z "**********"e "**********"r "**********") "**********": "**********"
...
def fix_tool_call_tokenization(
    ...
    # [TOOL_CALLS] token
    textual_tool_call_ids = "**********"
        text= "**********"
        add_special_tokens= "**********"
    )
 "**********"  "**********"  "**********"  "**********"  "**********"i "**********"f "**********"  "**********"m "**********"i "**********"s "**********"t "**********"r "**********"a "**********"l "**********"_ "**********"t "**********"o "**********"o "**********"l "**********"_ "**********"p "**********"a "**********"r "**********"s "**********"e "**********"r "**********". "**********"b "**********"o "**********"t "**********"_ "**********"t "**********"o "**********"k "**********"e "**********"n "**********"_ "**********"i "**********"d "**********"  "**********"i "**********"s "**********"  "**********"n "**********"o "**********"t "**********"  "**********"N "**********"o "**********"n "**********"e "**********": "**********"
        replacements.append((textual_tool_call_ids, mistral_tool_parser.bot_token_id))

    # [ARGS] token
 "**********"  "**********"  "**********"  "**********"  "**********"i "**********"f "**********"  "**********"m "**********"i "**********"s "**********"t "**********"r "**********"a "**********"l "**********"_ "**********"t "**********"o "**********"o "**********"l "**********"_ "**********"p "**********"a "**********"r "**********"s "**********"e "**********"r "**********". "**********"_ "**********"a "**********"r "**********"g "**********"s "**********"_ "**********"t "**********"o "**********"k "**********"e "**********"n "**********"_ "**********"i "**********"d "**********"  "**********"i "**********"s "**********"  "**********"n "**********"o "**********"t "**********"  "**********"N "**********"o "**********"n "**********"e "**********": "**********"
        textual_args_ids = "**********"
            text="[ARGS]",
            add_special_tokens= "**********"
        )
 ...
 "**********"  "**********"  "**********"  "**********"  "**********"i "**********"f "**********"  "**********"n "**********"o "**********"t "**********"  "**********"t "**********"o "**********"k "**********"e "**********"n "**********"s "**********"  "**********"o "**********"r "**********"  "**********"n "**********"o "**********"t "**********"  "**********"r "**********"e "**********"p "**********"l "**********"a "**********"c "**********"e "**********"m "**********"e "**********"n "**********"t "**********"s "**********": "**********"
        return tokens
    ...
    for textual_ids, special_id in replacements:
        ...
        new_result = []
        i = 0
 "**********"  "**********"  "**********"  "**********"  "**********"  "**********"  "**********"  "**********"  "**********"w "**********"h "**********"i "**********"l "**********"e "**********"  "**********"i "**********"  "**********"< "**********"  "**********"l "**********"e "**********"n "**********"( "**********"r "**********"e "**********"s "**********"u "**********"l "**********"t "**********"_ "**********"t "**********"o "**********"k "**********"e "**********"n "**********"s "**********") "**********": "**********"
            if result_tokens[i : "**********":
...
def stream_delta_message_generator(
 ...
 "**********"  "**********"  "**********"  "**********"  "**********"f "**********"o "**********"r "**********"  "**********"i "**********", "**********"  "**********"d "**********"e "**********"l "**********"t "**********"a "**********"_ "**********"t "**********"o "**********"k "**********"e "**********"n "**********"  "**********"i "**********"n "**********"  "**********"e "**********"n "**********"u "**********"m "**********"e "**********"r "**********"a "**********"t "**********"e "**********"( "**********"a "**********"l "**********"l "**********"_ "**********"t "**********"o "**********"k "**********"e "**********"n "**********"_ "**********"i "**********"d "**********"s "**********") "**********": "**********"
        delta_token_ids = "**********"
...
class TestExtractToolCallsNoTools:
 ...
 "**********"  "**********"  "**********"  "**********"  "**********"d "**********"e "**********"f "**********"  "**********"t "**********"e "**********"s "**********"t "**********"_ "**********"n "**********"o "**********"_ "**********"t "**********"o "**********"o "**********"l "**********"_ "**********"c "**********"a "**********"l "**********"l "**********"_ "**********"t "**********"o "**********"k "**********"e "**********"n "**********"( "**********"s "**********"e "**********"l "**********"f "**********", "**********"  "**********"m "**********"i "**********"s "**********"t "**********"r "**********"a "**********"l "**********"_ "**********"t "**********"o "**********"o "**********"l "**********"_ "**********"p "**********"a "**********"r "**********"s "**********"e "**********"r "**********") "**********": "**********"
...
def _test_extract_tool_calls_streaming(
 ...
 "**********"  "**********"  "**********"  "**********"  "**********"f "**********"o "**********"r "**********"  "**********"d "**********"e "**********"l "**********"t "**********"a "**********"_ "**********"m "**********"e "**********"s "**********"s "**********"a "**********"g "**********"e "**********"  "**********"i "**********"n "**********"  "**********"s "**********"t "**********"r "**********"e "**********"a "**********"m "**********"_ "**********"d "**********"e "**********"l "**********"t "**********"a "**********"_ "**********"m "**********"e "**********"s "**********"s "**********"a "**********"g "**********"e "**********"_ "**********"g "**********"e "**********"n "**********"e "**********"r "**********"a "**********"t "**********"o "**********"r "**********"( "**********"t "**********"o "**********"o "**********"l "**********"_ "**********"p "**********"a "**********"r "**********"s "**********"e "**********"r "**********", "**********"  "**********"t "**********"o "**********"k "**********"e "**********"n "**********"i "**********"z "**********"e "**********"r "**********", "**********"  "**********"t "**********"o "**********"o "**********"l "**********"s "**********") "**********": "**********"
...
class TestStreamingOneChunk:
    ...
    @pytest.mark.parametrize(
        ...
        [
            ...
            pytest.param(
                ...
                "",
                marks= "**********"="BPE tokenization merges }[ tokens"),
            ),
            # Content before tool
            (
    ...
    def test_streaming_one_chunk_v11(
        ...
        """
 "**********"  "**********"  "**********"  "**********"  "**********"  "**********"  "**********"  "**********"  "**********"i "**********"f "**********"  "**********"i "**********"s "**********"i "**********"n "**********"s "**********"t "**********"a "**********"n "**********"c "**********"e "**********"( "**********"m "**********"i "**********"s "**********"t "**********"r "**********"a "**********"l "**********"_ "**********"t "**********"o "**********"k "**********"e "**********"n "**********"i "**********"z "**********"e "**********"r "**********", "**********"  "**********"M "**********"i "**********"s "**********"t "**********"r "**********"a "**********"l "**********"T "**********"o "**********"k "**********"e "**********"n "**********"i "**********"z "**********"e "**********"r "**********") "**********": "**********"
            all_token_ids = "**********"
        else:
            all_token_ids = "**********"
                model_output, add_special_tokens= "**********"
            )
...
class TestEdgeCases:
 ...
 "**********"c "**********"l "**********"a "**********"s "**********"s "**********"  "**********"T "**********"e "**********"s "**********"t "**********"T "**********"o "**********"k "**********"e "**********"n "**********"B "**********"a "**********"s "**********"e "**********"d "**********"D "**********"e "**********"t "**********"e "**********"c "**********"t "**********"i "**********"o "**********"n "**********": "**********"
    """Test that token-based detection works correctly."""

 "**********"  "**********"  "**********"  "**********"  "**********"d "**********"e "**********"f "**********"  "**********"t "**********"e "**********"s "**********"t "**********"_ "**********"b "**********"o "**********"t "**********"_ "**********"t "**********"o "**********"k "**********"e "**********"n "**********"_ "**********"i "**********"d "**********"_ "**********"e "**********"x "**********"i "**********"s "**********"t "**********"s "**********"( "**********"s "**********"e "**********"l "**********"f "**********", "**********"  "**********"m "**********"i "**********"s "**********"t "**********"r "**********"a "**********"l "**********"_ "**********"t "**********"o "**********"o "**********"l "**********"_ "**********"p "**********"a "**********"r "**********"s "**********"e "**********"r "**********") "**********": "**********"
 ...
 "**********"  "**********"  "**********"  "**********"  "**********"d "**********"e "**********"f "**********"  "**********"t "**********"e "**********"s "**********"t "**********"_ "**********"a "**********"r "**********"g "**********"s "**********"_ "**********"t "**********"o "**********"k "**********"e "**********"n "**********"_ "**********"i "**********"d "**********"_ "**********"e "**********"x "**********"i "**********"s "**********"t "**********"s "**********"( "**********"s "**********"e "**********"l "**********"f "**********", "**********"  "**********"m "**********"i "**********"s "**********"t "**********"r "**********"a "**********"l "**********"_ "**********"t "**********"o "**********"o "**********"l "**********"_ "**********"p "**********"a "**********"r "**********"s "**********"e "**********"r "**********") "**********": "**********"
 ...
 "**********"  "**********"  "**********"  "**********"  "**********"d "**********"e "**********"f "**********"  "**********"t "**********"e "**********"s "**********"t "**********"_ "**********"s "**********"t "**********"r "**********"e "**********"a "**********"m "**********"i "**********"n "**********"g "**********"_ "**********"u "**********"s "**********"e "**********"s "**********"_ "**********"t "**********"o "**********"k "**********"e "**********"n "**********"_ "**********"i "**********"d "**********"s "**********"( "**********"s "**********"e "**********"l "**********"f "**********", "**********"  "**********"m "**********"i "**********"s "**********"t "**********"r "**********"a "**********"l "**********"_ "**********"t "**********"o "**********"o "**********"l "**********"_ "**********"p "**********"a "**********"r "**********"s "**********"e "**********"r "**********", "**********"  "**********"m "**********"i "**********"s "**********"t "**********"r "**********"a "**********"l "**********"_ "**********"t "**********"o "**********"k "**********"e "**********"n "**********"i "**********"z "**********"e "**********"r "**********") "**********": "**********"
        """Test that streaming correctly uses token IDs for detection."""
        # Content without tool call
        content_text = "Hello, how can I help you?"
        content_tokens = "**********"
            content_text, add_special_tokens= "**********"
        )
...
class TestParserInitialization:
 ...
 "**********"  "**********"  "**********"  "**********"  "**********"d "**********"e "**********"f "**********"  "**********"t "**********"e "**********"s "**********"t "**********"_ "**********"r "**********"e "**********"j "**********"e "**********"c "**********"t "**********"s "**********"_ "**********"p "**********"r "**********"e "**********"_ "**********"v "**********"1 "**********"1 "**********"_ "**********"t "**********"o "**********"k "**********"e "**********"n "**********"i "**********"z "**********"e "**********"r "**********"( "**********"s "**********"e "**********"l "**********"f "**********") "**********": "**********"
