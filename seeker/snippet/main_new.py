#date: 2025-04-04T16:55:27Z
#url: https://api.github.com/gists/84f5ead1d5f0fbc5f7b343d518c00f52
...
def get_parameters():
    ...
    default_params = {
        # Data parameters
        'csv_file': 'ADAUSDT_IOTAUSDT_1d_price_2020-03-05_to_2025-04-04.csv',  # CSV file path
        ...
        'sd_filter_enabled': True,  # Whether to use SD volatility filter
                    ...
                    try:
                        ...
                        if better_metric:
                            ...
                            for param_name, param_value in params.items():
                                if param_name in ['window_size', 'confidence_level', 'atr_multiplier', 'atr_on_equity']:
...
def create_dynamic_wfo_plots(is_range, oos_range, best_params, is_results, oos_results, output_dir):
    ...
    # 4. Trade Analysis by Copula Type
    if 'trades' in is_results and 'trades' in oos_results:
    ...
    # 5. Save detailed results summary as text
