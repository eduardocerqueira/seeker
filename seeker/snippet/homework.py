#date: 2024-11-08T16:42:07Z
#url: https://api.github.com/gists/096e51ae81beac69ac2e17317eef5f5d
#owner: https://api.github.com/users/Albuco
...
def is_longer_than_8_characters(word):
    return len(word) > 8

words = ["apple", "banana", "strawberry", "blueberry", "watermelon"]

for word in words:
    if is_longer_than_8_characters(word):
...
if are_anagrams(test_str1, test_str2):
...
sample_list = [5, 9, 3, 22, 10, 8]
max_number = find_max(sample_list)
