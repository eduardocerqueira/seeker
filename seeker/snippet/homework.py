#date: 2025-02-12T16:55:44Z
#url: https://api.github.com/gists/59e26e9ddf87254a2b35b2e23a6d30ed
...
friends['jess@gmail.com'] = 'Jess'
friends['justin@gmail.com'] = 'Justin'
...
for employee_id in employees:
    print(employees[employee_id]['name'], "-", employees[employee_id]['salary'])
# ----------------------------------------------------------------------------------------------------------------------
...
for year, title in films.items():
    print(f"{counter}. In {year}, the movie '{title}' was released.")
    counter +=1
# ----------------------------------------------------------------------------------------------------------------------
...
for pet_name, pet_info in shelter_pets.items():
    if not pet_info['Adopted']:
        print(pet_name)
...
for year, album_name in dylan_albums.items():
    print(year, album_name)

if 1998 in dylan_albums.keys():
    print('True')
else:
    print('False')
...
print(f'The highest scorer is {highest_scorer[0]} with a score of {highest_scorer[1]}')