#date: 2025-07-22T16:55:29Z
#url: https://api.github.com/gists/c0b402fb1cefc0c061b4910fe1b8ed94
#owner: https://api.github.com/users/angiechavarria
...
print(Temperature_fahrenheit) = 77
...
float_temperature = 24.8
integer_temperature = int (float_temperature)
print(integer_temperature) = 24
...
Total_chocolatechip = 17
total_cookies = 5

total_chocolatechip_per_cookie = Total_chocolatechip / total_cookies
print(total_chocolatechip_per_cookie) = 3.4



Total_chocolatechip = 17
total_cookies = 5
total_chocolatechip_per_cookie = 3.4

total_remaining_chips = total_chocolatechip_per_cookie / Total_chocolatechip
print(total_remaining_chips) = 0
