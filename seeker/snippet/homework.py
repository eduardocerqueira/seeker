#date: 2025-08-13T16:52:51Z
#url: https://api.github.com/gists/54eeef32bb5fd54590ef8632d64ef023
#owner: https://api.github.com/users/sbaker1290
...
friends = {}
friends['henry@gmail.com'] = "henry"
friends['alice1@yahoo.com'] = "alice"
friends['anna2@aol.com'] = "anna"

friends_prepopulated = {
    'henry@gmail.com': "henry",
    'alice1@yahoo.com': "alice",
    'anna2@aol.com': "anna"
}
print(friends)
...
employees = {
    1: {"name": "Alice Smith", "department": "HR","salary": 50000},
    2: {"name": "Bob Johnson", "department": "IT","salary": 70000},
    3: {"name": "Charlie Lee", "department": "Marketing","salary": 65000},
    4: {"name": "Diane Perez", "department": "Finance","salary": 75000},
    5: {"name": "Elliott Brown", "department": "Operations","salary": 60000}
...
print("Employee IDs:",list(employees.keys()))
# - Print the employee data for employee with the ID 3.
print("Employee ID 3:",employees[3])
...
for year, title in films.items():
    print(f"{counter}. {title} was released in {year}.")
    counter += 1
...
for year, album in dylan_albums.items():
    print(f"{album} was released in {year}")
...
if "Blood on the Tracks" in dylan_albums.values():
    print("Album found!")
else:
...
def find_max_score(scores_dict):
    ...
    return result
highest = find_max_score(test_scores)
print(highest)
