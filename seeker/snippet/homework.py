#date: 2024-07-18T16:55:44Z
#url: https://api.github.com/gists/be560a3492032205f01ec8cd67ee6a5c
#owner: https://api.github.com/users/Rstroud55
...
print(f'Age: {age}')
#for this exercise it was said to use .upper but I wasnt sure where it could be applied to the example
...
print(f'This is a character counter that will help you limit your text messages to keep them within the required limits.')
text_message = input(f'Type your message here: ')
char_count = len(text_message)
print(f'Your message has {char_count} + characters.')
...
last_name = data [5:10]
age = data [11:13]
print(f'Name: {first_name} {last_name.title()}\nAge: {age}')
# ---------------------------------------------------------------------
...
cardio = input('How many minutes do you spend on cardio? ')
strength = input('How many minutes do you spend on strength training? ')
yoga = input('How many minutes do you spend doing yoga? ')
total_time = int(cardio) + int(strength) + int(yoga)
print(f'Congratulations, you spent {total_time} minutes working out, just try to stay consistent!')
# ---------------------------------------------------------------------
...
rev_made_neg = str[0:1] + str[-1:0]
#Not sure why I couldnt get this one to work
# Output the result
# (ADD YOUR CODE BELOW)
print(rev_made_neg)
# ---------------------------------------------------------------------
...
print(f'Your average speed was {rounded_speed}')
