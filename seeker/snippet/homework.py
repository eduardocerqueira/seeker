#date: 2023-08-30T17:05:31Z
#url: https://api.github.com/gists/1ada464b97b75cbb56ab822e45fead87
#owner: https://api.github.com/users/PeachyKeane9
...
print('Exercise 1:\n 60 * 4 =', total_distance, "miles")  # print the result
...
print('Exercise 2:\n 8 / 4 =', int(slices_per_person), 'slices per person')
...
print('Exercise 4:\n 30 * (9/5) + 32 =', Fahrenheit, 'degrees Fahrenheit')
...
area_flowerbed = (3.141 * (3.5 ** 2))
print('Exercise 5:\n 3.141 * (3.5 ** 2) =', area_flowerbed, 'meters squared')
...
chocolate_chips = 17
cookies = 5
chocolate_chips_in_cookies = (chocolate_chips // cookies)
remaining_chips = (chocolate_chips % cookies)
print('Exercise 7:\n =', chocolate_chips_in_cookies, 'Chocolate Chip Cookies ' + 'and', remaining_chips, 'Remaining '
                                                                                                         'Chips')
...
print('Exercise 9:\n =', int(students_mean_age), 'years, average student age')
