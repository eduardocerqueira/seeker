#date: 2022-10-24T17:24:42Z
#url: https://api.github.com/gists/346f49435146b74c5e216907b3610398
#owner: https://api.github.com/users/camriddell
...
for (cyl, group), c in zip(plot_df.groupby('cylinders'), colors):
    ...
    transform = offset_copy(ax.get_yaxis_transform(), y=-5, fig=fig, units='points')
    hist_ax = ax.inset_axes([0, (cyl - 2) + (box_width * .5), 1, 2 - box_width], transform=transform, sharex=ax)
    hist_ax.axis('off')
