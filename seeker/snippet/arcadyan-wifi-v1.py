#date: 2023-06-12T16:58:57Z
#url: https://api.github.com/gists/1346b1e724a13c8a847b2e30c608bf64
...
# curl -X POST http: "**********": "admin", "password": "admin-password-goes-here"}'

 "**********"d "**********"e "**********"f "**********"  "**********"g "**********"e "**********"t "**********"_ "**********"t "**********"o "**********"k "**********"e "**********"n "**********"( "**********") "**********": "**********"
    curlyl = "{" # curly brackets don't play nice in formatted string
    curlyr = "}"
    print("\nStep 1. Obtaining access token")
    result = popen(f"curl -sSX POST http: "**********": \"admin\", \"password\": \"{admin_pass}\"{curlyr}'")
    output = result.read()
    token_start = output.find('\"token\": "**********"
    return output[token_start + 10 : "**********"

##############################
# Get wifi radio information #
##############################
# curl http: "**********":Bearer token-goes-here"

def get_wifi_info():
    print("\nStep 2. Obtaining wifi radio status")
    result = popen(f"curl -sS http: "**********":Bearer {token}")
    output = result.read()
    return output
...
####################################
# cat x.wifi-output.txt | curl -d "@-" http: "**********": Bearer token-goes-here'
...
def write_wifi_info():
    ...
    command_bash = "cat {} {} curl -vd \"@-\" http: "**********":Bearer {}".format(temp_wifi_out, vertical, b, token)
    command_zsh = "cat {} {} curl -vd \"@-\" http: "**********":Bearer {}".format(temp_wifi_out, vertical, b, b, token)
    ...
    result = popen("cat {} {} curl -vd \"@-\" http: "**********":Bearer {} ; say done".format(temp_wifi_out, vertical, b, token))
...
# Check the script before starting
 "**********"i "**********"f "**********"  "**********"a "**********"d "**********"m "**********"i "**********"n "**********"_ "**********"p "**********"a "**********"s "**********"s "**********"  "**********"= "**********"= "**********"  "**********"" "**********"a "**********"d "**********"m "**********"i "**********"n "**********"- "**********"p "**********"a "**********"s "**********"s "**********"w "**********"o "**********"r "**********"d "**********"- "**********"h "**********"e "**********"r "**********"e "**********"" "**********": "**********"
