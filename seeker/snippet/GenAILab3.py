...
#url: https://api.github.com/gists/7bff4b437e888aa4661e735b314512e5
#owner: https://api.github.com/users/plushycat

'''
QUESTION:
Train a custom Word2Vec model on a small dataset. Train embeddings on a domain specific corpus (e.g., legal, medical) and 
...
for i, word in enumerate(words):
    plt.text(tsne_result[i,0], tsne_result[i,1] + 0.02, word, fontsize=12)
