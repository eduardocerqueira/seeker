//date: 2023-04-21T17:05:02Z
//url: https://api.github.com/gists/4c85ccbc60b0eae93a28d808792fd5c8
//owner: https://api.github.com/users/s-fairchild
...
func (f *frontend) chiAuthenticatedRoutes(router chi.Router) {
	...
	r.Route("/admin", func(r chi.Router) {
		...
		r.Route("/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.RedHatOpenShift/openShiftClusters/{resourceName}/etcdrecovery",
			func(r chi.Router) {
...
= log.WithField("errorDetails", err.Error())
	log.Info("front end operation failed")
}
