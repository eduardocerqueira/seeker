//date: 2025-12-01T17:10:23Z
//url: https://api.github.com/gists/dc86d29a0abc802f4ef22e669428157a
//owner: https://api.github.com/users/DmitriiMukhin
	...
	private void writeProgramGlobalVariables(Program program, PrintWriter headerWriter, TaskMonitor monitor)
		...
		for (Symbol sym : smgr.getAllSymbols(true)) {
			...
			if (data_type_name.endsWith("]")) {
				String[] tokens = "**********"
 "**********"	 "**********"	 "**********"	 "**********"	 "**********"a "**********"s "**********"s "**********"e "**********"r "**********"t "**********"  "**********"t "**********"o "**********"k "**********"e "**********"n "**********"s "**********". "**********"l "**********"e "**********"n "**********"g "**********"t "**********"h "**********"  "**********"= "**********"= "**********"  "**********"2 "**********"; "**********"
				data_type_name = "**********"
				name_suffix = "**********"
			}
