#date: 2024-01-08T16:57:34Z
#url: https://api.github.com/gists/ad1d5daacd0c54c1b59ee6cd1b327379
#owner: https://api.github.com/users/MF366-Coding
...
def download_video(**kwargs):
    ...
    if not is_playlist:
        ...
        try:
            youtubeDownload.download(filename=filename, timeout=int(ytStreams.length / 2) + clamp(extra_timeout, 0, ytStreams.length * 3))
