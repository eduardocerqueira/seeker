#date: 2024-05-22T16:54:41Z
#url: https://api.github.com/gists/4262be2822531c81ac21fe717bc76c6f
#owner: https://api.github.com/users/LearhCodez
...
second_friend_name = list2[1]
last_friend_age = list3[2][1]
# ---------------------------------------------------------------------
...
whole_week = 'Your total steps for the week: ' + str(sum(steps))
work_days = 'Your total steps during your work week: ' + str(sum(steps[:5:]))
