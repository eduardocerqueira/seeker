//date: 2022-02-17T17:07:21Z
//url: https://api.github.com/gists/1832786cf053daa51bf188110b764090
//owner: https://api.github.com/users/torchlight
...
public class MinoRotationImpl implements MinoRotation {
    ...
    private static final boolean USE_SRS_PLUS = true;
    ...
    private EnumMap<Piece, EnumMap<Rotate, Pattern>> createRightMap() {
        ...
        for (Piece piece : Piece.values()) {
            ...
            if (piece != Piece.I || !USE_SRS_PLUS) {
                ...
                rotateMap.put(Rotate.Spawn, new Pattern(new int[][]{
                    {1, 0}, {2, 0}, {-1, 0}, {-1, -1}, {2, 2},
                    /*
                    basic rotation coordinate system:
                    {0, 0}, {1, 0}, {-2, 0}, {-2, -1}, {1, 2}
                    */
                }));
                rotateMap.put(Rotate.Right, new Pattern(new int[][]{
                    {0, -1}, {-1, -1}, {2, -1}, {-1, 1}, {2, -2},
                    /*
                    basic rotation coordinate system:
                    {0, 0}, {-1, 0}, {2, 0}, {-1, 2}, {2, -1}
                ...
                rotateMap.put(Rotate.Reverse, new Pattern(new int[][]{
                    {-1, 0}, {1, 0}, {-2, 0}, {1, 1}, {-2, -2},
                    /*
                    basic rotation coordinate system:
                    {0, 0}, {2, 0}, {-1, 0}, {2, 1}, {-1, -2}
                ...
                rotateMap.put(Rotate.Left, new Pattern(new int[][]{
                    {0, 1}, {1, 1}, {-2, 1}, {1, -1}, {-2, 2},
                    /*
                    basic rotation coordinate system:
                    {0, 0}, {1, 0}, {-2, 0}, {1, -2}, {-2, 1}
    ...
    private Pattern getPatternRotate180(Piece piece, Rotate current) {
        switch (piece) {
            case I: {
                // basic 180 kick table (e.g. Jstris, TETR.IO)
                switch (current) {
                    case Spawn:
            ...
            case O: {
                // never allow 180 spins of the O piece
                return new Pattern(new int[][]{});
            }
            default: {
                if (USE_SRS_PLUS) {
                    // TETR.IO's 180 kick table
                    switch (current) {
                        case Spawn:
                            return new Pattern(new int[][]{
                    ...
                    // basic 180 kick table (e.g. Jstris)
                    switch (current) {
                    case Spawn:
                        return new Pattern(new int[][]{
                                {0, 0}, {0, 1},
