#date: 2026-02-17T17:51:38Z
#url: https://api.github.com/gists/a3f62a43d72c6397721047711b63ddd9
#owner: https://api.github.com/users/mabeljeong
...
def make_request(client: "**********": str, max_tokens: int = 128, max_retries: int = 5) -> tuple[str | None, str | None]:
    ...
    if prefill:
        ...
        prefill_block: TextBlockParam = {
            "type": "text",
            "text": prefill.rstrip(),
            "cache_control": "**********": "ephemeral"} # Cache to save cost and hitting the same KV cache for consistency (min 4096 tokens for Opus-4-5)
        }
...
def fetch_responses(prefill: "**********": int, max_tokens: int) -> tuple[list[str], list[str]]:
...
def run_sample(prefill_file: "**********": int, max_tokens: int):
...
def run_extraction(
 ...
 "**********"  "**********"  "**********"  "**********"  "**********"  "**********"  "**********"  "**********"  "**********"  "**********"  "**********"  "**********"  "**********"i "**********"f "**********"  "**********"i "**********"t "**********"e "**********"r "**********"a "**********"t "**********"i "**********"o "**********"n "**********"  "**********"= "**********"= "**********"  "**********"1 "**********"  "**********"a "**********"n "**********"d "**********"  "**********"s "**********"t "**********"a "**********"r "**********"t "**********"_ "**********"t "**********"o "**********"k "**********"e "**********"n "**********"s "**********": "**********"
                current_tokens = "**********"
 "**********"  "**********"  "**********"  "**********"  "**********"  "**********"  "**********"  "**********"  "**********"  "**********"  "**********"  "**********"  "**********"e "**********"l "**********"i "**********"f "**********"  "**********"l "**********"a "**********"s "**********"t "**********"_ "**********"s "**********"u "**********"c "**********"c "**********"e "**********"s "**********"s "**********"f "**********"u "**********"l "**********"_ "**********"t "**********"o "**********"k "**********"e "**********"n "**********"s "**********"  "**********"a "**********"n "**********"d "**********"  "**********"l "**********"a "**********"s "**********"t "**********"_ "**********"s "**********"u "**********"c "**********"c "**********"e "**********"s "**********"s "**********"f "**********"u "**********"l "**********"_ "**********"t "**********"o "**********"k "**********"e "**********"n "**********"s "**********"  "**********"< "**********"  "**********"m "**********"a "**********"x "**********"_ "**********"t "**********"o "**********"k "**********"e "**********"n "**********"s "**********": "**********"
                # Ramp up: "**********"
                current_tokens = "**********"
            else:
                current_tokens = "**********"
            ...
            while True:  # Adaptive retry loop
                log(f"\n{'='*50}", log_lines)
                log(f"Iteration {iteration} | Prefill length: "**********": {current_tokens}", log_lines)
                if prefill:
 ...
 "**********"  "**********"  "**********"  "**********"  "**********"  "**********"  "**********"  "**********"  "**********"  "**********"  "**********"  "**********"  "**********"  "**********"  "**********"  "**********"  "**********"e "**********"l "**********"i "**********"f "**********"  "**********"a "**********"d "**********"a "**********"p "**********"t "**********"i "**********"v "**********"e "**********"  "**********"a "**********"n "**********"d "**********"  "**********"c "**********"u "**********"r "**********"r "**********"e "**********"n "**********"t "**********"_ "**********"t "**********"o "**********"k "**********"e "**********"n "**********"s "**********"  "**********"> "**********"  "**********"m "**********"i "**********"n "**********"_ "**********"t "**********"o "**********"k "**********"e "**********"n "**********"s "**********": "**********"
                    current_tokens = "**********"
                    log(f"\nNo consensus. Adaptive: "**********"
...
if __name__ == "__main__":
    ...
    parser.add_argument("-m", "--max-tokens", type= "**********"=100,
                        help="Max tokens per response (default: "**********"
    ...
    parser.add_argument("-a", "--adaptive", action="store_true",
                        help="Adaptive mode: "**********"
    parser.add_argument("-mt", "--min-tokens", type= "**********"=20,
                        help="Minimum tokens for adaptive mode (default: "**********"
    parser.add_argument("-st", "--start-tokens", type= "**********"=None,
                        help="Starting tokens for adaptive mode (default: "**********"
