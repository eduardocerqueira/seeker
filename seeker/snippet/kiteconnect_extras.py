#date: 2024-01-24T17:08:45Z
#url: https://api.github.com/gists/ed26f2173911ee32abd56237ac26dacc
#owner: https://api.github.com/users/anupamram
...
class KiteExtTicker(KiteTicker):
 ...
 "**********"  "**********"  "**********"  "**********"  "**********"  "**********"  "**********"  "**********"  "**********"  "**********"  "**********"  "**********"  "**********"  "**********"  "**********"  "**********"  "**********"f "**********"o "**********"r "**********"  "**********"t "**********"o "**********"k "**********"e "**********"n "**********"  "**********"i "**********"n "**********"  "**********"i "**********"n "**********"s "**********"t "**********"r "**********"u "**********"m "**********"e "**********"n "**********"t "**********"_ "**********"t "**********"o "**********"k "**********"e "**********"n "**********"s "**********": "**********"
 ...
 "**********"  "**********"  "**********"  "**********"  "**********"  "**********"  "**********"  "**********"  "**********"  "**********"  "**********"  "**********"  "**********"  "**********"  "**********"  "**********"  "**********"f "**********"o "**********"r "**********"  "**********"t "**********"o "**********"k "**********"e "**********"n "**********"  "**********"i "**********"n "**********"  "**********"i "**********"n "**********"s "**********"t "**********"r "**********"u "**********"m "**********"e "**********"n "**********"t "**********"_ "**********"t "**********"o "**********"k "**********"e "**********"n "**********"s "**********": "**********"
    ...
    def set_mode(self, *args, **kwargs):
        ...
        if self.with_shared_ticks:
            ...
            try:
                mode, instrument_tokens = args[: "**********"
                self.ws.sendMessage(
                    six.b(
                        json.dumps(
                            {"a": "**********": [mode, instrument_tokens]}
                        )
                    )
                )
 ...
 "**********"  "**********"  "**********"  "**********"  "**********"  "**********"  "**********"  "**********"  "**********"  "**********"  "**********"  "**********"  "**********"  "**********"  "**********"  "**********"  "**********"  "**********"  "**********"  "**********"  "**********"  "**********"  "**********"  "**********"  "**********"  "**********"  "**********"  "**********"  "**********"i "**********"f "**********"  "**********"k "**********"  "**********"i "**********"n "**********"  "**********"s "**********"e "**********"l "**********"f "**********". "**********"s "**********"u "**********"b "**********"s "**********"c "**********"r "**********"i "**********"b "**********"e "**********"d "**********"_ "**********"t "**********"o "**********"k "**********"e "**********"n "**********"s "**********"  "**********"o "**********"r "**********"  "**********"k "**********"  "**********"= "**********"= "**********"  "**********"" "**********"o "**********"r "**********"d "**********"e "**********"r "**********"_ "**********"u "**********"p "**********"d "**********"a "**********"t "**********"e "**********"" "**********"
                        }
                    )
                del latest_ticks
 ...
 "**********"  "**********"  "**********"  "**********"  "**********"  "**********"  "**********"  "**********"  "**********"  "**********"  "**********"  "**********"  "**********"i "**********"f "**********"  "**********"u "**********"s "**********"e "**********"r "**********"_ "**********"i "**********"d "**********"  "**********"= "**********"= "**********"  "**********"" "**********"" "**********"  "**********"o "**********"r "**********"  "**********"e "**********"n "**********"c "**********"t "**********"o "**********"k "**********"e "**********"n "**********"  "**********"= "**********"= "**********"  "**********"" "**********"" "**********": "**********"
                raise ValueError(
...
class KiteExt(KiteConnect):
 ...
 "**********"  "**********"  "**********"  "**********"  "**********"  "**********"  "**********"  "**********"  "**********"i "**********"f "**********"  "**********"l "**********"e "**********"n "**********"( "**********"s "**********"e "**********"l "**********"f "**********". "**********"h "**********"i "**********"s "**********"t "**********"o "**********"r "**********"i "**********"c "**********"a "**********"l "**********"_ "**********"i "**********"n "**********"s "**********"t "**********"r "**********"u "**********"m "**********"e "**********"n "**********"t "**********"_ "**********"t "**********"o "**********"k "**********"e "**********"n "**********"s "**********") "**********"  "**********"! "**********"= "**********"  "**********"0 "**********": "**********"
 ...
 "**********"  "**********"  "**********"  "**********"  "**********"  "**********"  "**********"  "**********"  "**********"i "**********"f "**********"  "**********"i "**********"n "**********"s "**********"t "**********"r "**********"u "**********"m "**********"e "**********"n "**********"t "**********"_ "**********"t "**********"o "**********"k "**********"e "**********"n "**********"s "**********"  "**********"i "**********"s "**********"  "**********"n "**********"o "**********"t "**********"  "**********"N "**********"o "**********"n "**********"e "**********": "**********"
            self.historical_instrument_tokens.update(set(instrument_tokens))
 "**********"  "**********"  "**********"  "**********"  "**********"  "**********"  "**********"  "**********"  "**********"i "**********"f "**********"  "**********"l "**********"e "**********"n "**********"( "**********"s "**********"e "**********"l "**********"f "**********". "**********"h "**********"i "**********"s "**********"t "**********"o "**********"r "**********"i "**********"c "**********"a "**********"l "**********"_ "**********"i "**********"n "**********"s "**********"t "**********"r "**********"u "**********"m "**********"e "**********"n "**********"t "**********"_ "**********"t "**********"o "**********"k "**********"e "**********"n "**********"s "**********") "**********"  "**********"= "**********"= "**********"  "**********"0 "**********": "**********"
            raise ValueError(
    ...
    def __init__(
        ...
        subscribe_tick_inst_tokens: "**********"
        subscribe_historical_inst_tokens: "**********"
        *args,
        **kwargs,
    ):
        ...
        self.historical_instrument_tokens: "**********"
    ...
    def login_using_enctoken(
        self, userid: "**********": str, public_token: Optional[str] = None
    ) -> None:
        self.user_id = userid
        self.enctoken = "**********"
        self.public_token = "**********"
        self.set_headers(enctoken, userid= "**********"
 ...
 "**********"  "**********"  "**********"  "**********"  "**********"  "**********"  "**********"  "**********"  "**********"  "**********"  "**********"  "**********"  "**********"  "**********"  "**********"  "**********"  "**********"  "**********"  "**********"  "**********"  "**********"  "**********"  "**********"  "**********"  "**********"i "**********"f "**********"  "**********"c "**********"o "**********"o "**********"k "**********"i "**********"e "**********". "**********"k "**********"e "**********"y "**********"  "**********"= "**********"= "**********"  "**********"" "**********"e "**********"n "**********"c "**********"t "**********"o "**********"k "**********"e "**********"n "**********"" "**********": "**********"
                            self.enctoken = "**********"
 ...
 "**********"  "**********"  "**********"  "**********"  "**********"  "**********"  "**********"  "**********"  "**********"  "**********"  "**********"  "**********"  "**********"  "**********"  "**********"  "**********"  "**********"  "**********"  "**********"  "**********"  "**********"i "**********"f "**********"  "**********"r "**********"e "**********"s "**********"p "**********". "**********"c "**********"o "**********"o "**********"k "**********"i "**********"e "**********"s "**********". "**********"g "**********"e "**********"t "**********"( "**********"" "**********"p "**********"u "**********"b "**********"l "**********"i "**********"c "**********"_ "**********"t "**********"o "**********"k "**********"e "**********"n "**********"" "**********") "**********"  "**********"i "**********"s "**********"  "**********"n "**********"o "**********"t "**********"  "**********"N "**********"o "**********"n "**********"e "**********": "**********"
                        self.public_token = "**********"
 ...
 "**********"  "**********"  "**********"  "**********"  "**********"  "**********"  "**********"  "**********"  "**********"  "**********"  "**********"  "**********"  "**********"  "**********"  "**********"  "**********"  "**********"  "**********"  "**********"  "**********"  "**********"  "**********"  "**********"  "**********"  "**********"  "**********"  "**********"  "**********"  "**********"  "**********"  "**********"  "**********"  "**********"  "**********"  "**********"  "**********"  "**********"a "**********"n "**********"d "**********"  "**********"j "**********"s "**********"o "**********"n "**********"_ "**********"b "**********"o "**********"d "**********"y "**********"[ "**********"" "**********"e "**********"r "**********"r "**********"o "**********"r "**********"_ "**********"t "**********"y "**********"p "**********"e "**********"" "**********"] "**********"  "**********"= "**********"= "**********"  "**********"" "**********"T "**********"o "**********"k "**********"e "**********"n "**********"E "**********"x "**********"c "**********"e "**********"p "**********"t "**********"i "**********"o "**********"n "**********"" "**********"
                                ):
                                    self.session_expiry_hook()
                                # native Kite errors
                                exp = getattr(
 ...
 "**********"  "**********"  "**********"  "**********"  "**********"  "**********"  "**********"  "**********"  "**********"  "**********"  "**********"  "**********"  "**********"i "**********"f "**********"  "**********"r "**********"e "**********"t "**********"u "**********"r "**********"n "**********"_ "**********"t "**********"o "**********"k "**********"e "**********"n "**********"_ "**********"w "**********"i "**********"s "**********"e "**********"_ "**********"d "**********"f "**********": "**********"
                return {inst_token: "**********"
            else:
 ...
 "**********"  "**********"  "**********"  "**********"  "**********"  "**********"  "**********"  "**********"  "**********"  "**********"  "**********"  "**********"  "**********"i "**********"f "**********"  "**********"r "**********"e "**********"t "**********"u "**********"r "**********"n "**********"_ "**********"t "**********"o "**********"k "**********"e "**********"n "**********"_ "**********"w "**********"i "**********"s "**********"e "**********"_ "**********"d "**********"f "**********": "**********"
    ...
    def historical_data(
        ...
        url_args = {"instrument_token": "**********": interval}
        params = {
