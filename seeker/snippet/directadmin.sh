#date: 2024-04-24T17:08:48Z
#url: https://api.github.com/gists/3b7467fc66972bbbe5975542dcdf63b9
#owner: https://api.github.com/users/golles

#!/usr/bin/env bash

 "**********"# "**********"  "**********"I "**********"n "**********"f "**********"o "**********"  "**********"a "**********"b "**********"o "**********"u "**********"t "**********"  "**********"u "**********"s "**********"e "**********"r "**********"n "**********"a "**********"m "**********"e "**********"  "**********"p "**********"a "**********"s "**********"s "**********"w "**********"o "**********"r "**********"d "**********": "**********"
