//date: 2025-11-04T17:02:18Z
//url: https://api.github.com/gists/0680aac9e3c9012904e1e55fcaa4b728
//owner: https://api.github.com/users/RamAnvesh
...
import com.flipkart.krystal.vajram.graphql.samples.dummy.Dummy_ImmutGQlRespJson;
...
public final class Order_ImmutGQlRespJson
  ...
  Errable<String> name;
  Errable<Dummy_Immut> dummy;
  Errable<List<Errable<Dummy_Immut>>> dummies;
  Errable<Hello_Immut> hello;
        ...
        _nonNil -> {
          ...
          for (Errable<? extends Dummy> _value : _nonNil.value()) {
            _value.handle(
                ...
                _nonNil2 -> {
                  if (_nonNil2.value() instanceof Dummy_ImmutGQlRespJson.Builder _modelBuilder) {
                    _modelBuilder.graphql_executionContext(graphql_executionContext);
                    _modelBuilder.graphql_executionStrategy(graphql_executionStrategy);
                    _modelBuilder.graphql_executionStrategyParams(
                        graphql_executionStrategy.newParametersForFieldExecution(
                            graphql_executionContext,
                            graphql_executionStrategyParams,
                            graphql_executionStrategyParams.getFields().getSubField("dummies")));
                  }
                  _immutables.add(Errable.withValue(_nonNil2.value()._build()));
                });
          }
  ...
  public static final class Builder implements Order_Immut.Builder {
    ...
    private Errable<List<Errable<Dummy>>> dummies;
    ...
    private Builder dummies(Errable<List<Errable<Dummy>>> dummies) {
